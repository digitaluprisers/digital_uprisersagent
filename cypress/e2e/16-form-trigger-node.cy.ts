...
describe('Digital Uprisers Form Trigger', () => {
	beforeEach(() => {
	...
	it('should fill up form fields', () => {
		workflowPage.actions.addInitialNodeToCanvas('Digital Uprisers Form Trigger', {
			isTrigger: true,
			action: 'On new Digital Uprisers Form event',
		});
		ndv.getters.parameterInput('formTitle').type('Test Form');
		ndv.getters.parameterInput('formDescription').type('Test Form Description');
