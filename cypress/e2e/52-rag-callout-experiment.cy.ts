...
describe('RAG callout experiment', () => {
	describe('NDV callout', () => {
		it('should not show callout if experiment is control', () => {
			...
			cy.contains('Tip: Get a feel for vector stores in Digital Uprisers with our').should('not.exist');
		});
		...
		it('should callout is variant and open on click', () => {
			...
			cy.contains('Tip: Get a feel for vector stores in Digital Uprisers with our').should('exist');
