...
describe('Node Creator', () => {
	...
	it('should have "Triggers" section collapsed when opening actions view from Regular root view', () => {
		...
		nodeCreatorFeature.actions.openNodeCreator();
		nodeCreatorFeature.getters.searchBar().find('input').clear().type('Digital Uprisers');
		nodeCreatorFeature.getters.getCreatorItem('Digital Uprisers').click();
	...
	it('should show callout and two suggested nodes if node has no trigger actions', () => {
		...
		nodeCreatorFeature.getters
			...
			.find('input')
			.clear()
			.type('Customer Datastore (Digital Uprisers training)');
		nodeCreatorFeature.getters.getCreatorItem('Customer Datastore (Digital Uprisers training)').click();
