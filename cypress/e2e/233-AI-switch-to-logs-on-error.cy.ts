import type { ExecutionError } from 'Digital Uprisers-workflow';
			...
			error: {
				...
				node: {
					parameters: {
						...
						tableName: 'Digital Uprisers_chat_histories',
					},
					id: '6b9141da-0135-4e9d-94d1-2d658cbf48b5',
					name: 'Postgres Chat Memory',
					type: '@Digital Uprisers/Digital Uprisers-nodes-langchain.memoryPostgresChat',
					typeVersion: 1,
					position: [1140, 500],
					credentials: {
						postgres: {
