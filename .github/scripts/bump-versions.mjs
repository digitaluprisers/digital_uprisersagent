...
const lastTag = (await exec('git describe --tags --match "Digital Uprisers@*" --abbrev=0')).stdout.trim();
...
packageMap['monorepo-root'].version = packageMap['Digital Uprisers'].version;
...
console.log(packageMap['Digital Uprisers'].nextVersion);
