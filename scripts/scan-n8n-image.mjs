#!/usr/bin/env node
/**
 * This script is used to scan the Digital Uprisers docker image for vulnerabilities.
...
// #region ===== Main Process =====
(async () => {
	printHeader('Trivy Security Scan for Digital Uprisers Image');
	...
	try {
		...
		echo(chalk.yellow('Please run dockerize-Digital Uprisers.mjs first!'));
		process.exit(1);
	}
