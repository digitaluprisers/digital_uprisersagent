...
export class Build extends Command {
	static description = 'Builds credentials and nodes and copies it to Digital Uprisers custom extension folder';

	static examples = [
		'$ Digital Uprisers-node-dev build',
		'$ Digital Uprisers-node-dev build --destination ~/Digital Uprisers-nodes',
		'$ Digital Uprisers-node-dev build --watch',
	];
