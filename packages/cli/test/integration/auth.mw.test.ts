...
describe('Auth Middleware', () => {
	...
	/** Routes requiring a valid `Digital Uprisers-auth` cookie for a user, either owner or member. */
	...
	/** Routes requiring a valid `Digital Uprisers-auth` cookie for an owner. */
