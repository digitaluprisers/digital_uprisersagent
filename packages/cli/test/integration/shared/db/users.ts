import { randomEmail, randomName, randomValidPassword } from '@Digital Uprisers/backend-test-utils';
...
import type { ApiKeyScope, GlobalRole } from '@Digital Uprisers/permissions';
