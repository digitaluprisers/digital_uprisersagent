...
import type { WorkflowWithSharingsMetaDataAndCredentials } from '@Digital Uprisers/db';
...
import { ApplicationError, WorkflowActivationError, type INode } from 'Digital Uprisers-workflow';
			...
			const changedNodes: INode[] = [
				{
					...
					position: [-20, 555],
					type: 'Digital Uprisers-nodes-base.no-op',
					typeVersion: 1,
					credentials: {
						default: {
							id: '200',
