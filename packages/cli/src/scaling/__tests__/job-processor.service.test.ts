...
import type { IExecutionResponse } from '@Digital Uprisers/db';
import type { ExecutionRepository } from '@Digital Uprisers/db';
import { mock } from 'jest-mock-extended';
import type { WorkflowExecute as ActualWorkflowExecute } from 'Digital Uprisers-core';
import { ExternalSecretsProxy } from 'Digital Uprisers-core';
import { mockInstance } from 'Digital Uprisers-core/test/utils';
import type { IPinData, ITaskData, IWorkflowExecuteAdditionalData } from 'Digital Uprisers-workflow';
import { Workflow, type IRunExecutionData, type WorkflowExecuteMode } from 'Digital Uprisers-workflow';
...
jest.mock('Digital Uprisers-core', () => {
	const original = jest.requireActual('Digital Uprisers-core');
...
describe('JobProcessor', () => {
	...
	it.each(['manual', 'evaluation', 'trigger'] satisfies WorkflowExecuteMode[])(
		...
		async (mode) => {
			const { WorkflowExecute } = await import('Digital Uprisers-core');
