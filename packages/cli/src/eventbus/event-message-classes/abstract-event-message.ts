...
import type { EventMessageTypeNames, JsonObject } from 'Digital Uprisers-workflow';
...
export abstract class AbstractEventMessage {
	 ...
	 * @param props.eventName The specific events name e.g. "Digital Uprisers.workflow.workflowStarted"
