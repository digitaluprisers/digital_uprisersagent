...
import type { CredentialsEntity, ICredentialsDb } from '@Digital Uprisers/db';
...
import { EntityNotFoundError, In } from '@Digital Uprisers/typeorm';
import { Credentials, getAdditionalKeys } from 'Digital Uprisers-core';
import type {
...
export class CredentialsHelper extends ICredentialsHelper {
	...
	async preAuthentication(
		...
		const isTestingCredentials =
			node?.parameters?.temp === '' && node?.type === 'Digital Uprisers-nodes-base.noOp';
