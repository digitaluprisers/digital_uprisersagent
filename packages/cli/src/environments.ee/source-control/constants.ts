...
export const SOURCE_CONTROL_GIT_KEY_COMMENT = 'Digital Uprisers deploy key';
...
# Digital Uprisers Source Control
`;
export const SOURCE_CONTROL_DEFAULT_NAME = 'Digital Uprisers user';
export const SOURCE_CONTROL_DEFAULT_EMAIL = 'Digital Uprisers@example.com';
