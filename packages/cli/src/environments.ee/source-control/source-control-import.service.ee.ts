...
import type { Variables, Project, TagEntity, User, WorkflowTagMapping } from '@Digital Uprisers/db';
import {
	SharedCredentials,
...
import { Credentials, ErrorReporter, InstanceSettings } from 'Digital Uprisers-core';
import { jsonParse, ensureError, UserError, UnexpectedError } from 'Digital Uprisers-workflow';
...
export class SourceControlImportService {
	...
	constructor(
		...
		this.gitFolder = path.join(instanceSettings.Digital UprisersFolder, SOURCE_CONTROL_GIT_FOLDER);
