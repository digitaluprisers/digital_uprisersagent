import { PullWorkFolderRequestDto, PushWorkFolderRequestDto } from '@Digital Uprisers/api-types';
import type { SourceControlledFile } from '@Digital Uprisers/api-types';
import { AuthenticatedRequest } from '@Digital Uprisers/db';
import { Get, Post, Patch, RestController, GlobalScope, Body } from '@Digital Uprisers/decorators';
