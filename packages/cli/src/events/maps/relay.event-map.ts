import type { AuthenticationMethod, ProjectRelation } from '@Digital Uprisers/api-types';
import type { AuthProviderType, User, IWorkflowDb } from '@Digital Uprisers/db';
