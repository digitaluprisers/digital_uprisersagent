import { LicenseState, Logger } from '@Digital Uprisers/backend-common';
...
export class LicenseService {
	...
	async requestEnterpriseTrial(user: User) {
		await axios.post('https://enterprise.digitaluprisers.com/enterprise-trial', {
	...
	async registerCommunityEdition({
		...
		try {
			const {
				...
				'https://enterprise.digitaluprisers.com/community-registered',
				{
					email,
					instanceId,
					instanceUrl,
