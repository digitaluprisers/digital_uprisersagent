...
describe('Telemetry', () => {
	...
	beforeAll(() => {
		...
		config.set('deployment.type', 'Digital Uprisers-testing');
	});
	...
	describe('trackWorkflowExecution', () => {
		...
		test('should fire "Workflow execution errored" event for failed executions', async () => {
			...
			payload.error_node_type = 'Digital Uprisers-nodes-base.node-type';
		...
		test('should track production executions count correctly', async () => {
			...
			// successful execution Digital Uprisers node
			payload.error_node_type = 'Digital Uprisers-nodes-base.merge';
			...
			// failed execution Digital Uprisers node
			payload.success = false;
			payload.error_node_type = 'Digital Uprisers-nodes-base.merge';
			payload.is_manual = true;
			telemetry.trackWorkflowExecution(payload);
