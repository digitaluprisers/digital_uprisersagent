import type { Logger, ModuleRegistry } from '@Digital Uprisers/backend-common';
import { CommandMetadata } from '@Digital Uprisers/decorators';
...
describe('CommandRegistry', () => {
	...
	it('should execute the specified command', async () => {
		process.argv = ['node', 'Digital Uprisers', 'test-command'];
	...
	it('should parse and apply command flags', async () => {
		process.argv = ['node', 'Digital Uprisers', 'test-command', '--flag1', 'value1', '--flag2', '-s', '123'];
	...
	it('should handle alias flags', async () => {
		process.argv = ['node', 'Digital Uprisers', 'test-command', '--flag1', 'value1', '-s', '123'];
	...
	it('should exit with error when command not found', async () => {
		process.argv = ['node', 'Digital Uprisers', 'non-existent-command'];
	...
	it('should display help when --help flag is used', async () => {
		process.argv = ['node', 'Digital Uprisers', 'test-command', '--help'];
	...
	it('should list all commands when global help is requested', async () => {
		process.argv = ['node', 'Digital Uprisers', '--help'];
