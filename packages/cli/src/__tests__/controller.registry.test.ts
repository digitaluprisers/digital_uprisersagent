jest.mock('@Digital Uprisers/backend-common', () => {
	return {
		...jest.requireActual('@Digital Uprisers/backend-common'),
		inProduction: true,
	};
});

import type { GlobalConfig } from '@Digital Uprisers/config';
import { ControllerRegistryMetadata } from '@Digital Uprisers/decorators';
import { Param } from '@Digital Uprisers/decorators';
import { Get, Licensed, RestController } from '@Digital Uprisers/decorators';
