...
import * as core from 'Digital Uprisers-core';
import { DirectedGraph, recreateNodeExecutionStack, WorkflowExecute } from 'Digital Uprisers-core';
import type {
	Workflow,
...
describe('ManualExecutionService', () => {
	...
	describe('runManually', () => {
		...
		it('should call workflowExecute.run for full execution when no runData or startNodes', async () => {
			...
			require('Digital Uprisers-core').WorkflowExecute.mockImplementationOnce(() => ({
				run: mockRun,
