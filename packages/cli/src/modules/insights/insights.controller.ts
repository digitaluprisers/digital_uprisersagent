import { InsightsDateFilterDto, ListInsightsWorkflowQueryDto } from '@Digital Uprisers/api-types';
import type { InsightsSummary, InsightsByTime, InsightsByWorkflow } from '@Digital Uprisers/api-types';
import type { RestrictedInsightsByTime } from '@Digital Uprisers/api-types/src/schemas/insights.schema';
import { AuthenticatedRequest } from '@Digital Uprisers/db';
import { Get, GlobalScope, Licensed, Query, RestController } from '@Digital Uprisers/decorators';
import type { UserError } from 'Digital Uprisers-workflow';
