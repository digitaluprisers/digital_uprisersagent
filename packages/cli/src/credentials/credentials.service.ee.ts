import type { CredentialsEntity, User } from '@Digital Uprisers/db';
import { Project, SharedCredentials, SharedCredentialsRepository } from '@Digital Uprisers/db';
...
import { In, type EntityManager } from '@Digital Uprisers/typeorm';
import type { ICredentialDataDecryptedObject } from 'Digital Uprisers-workflow';
		...
		credential = includeDecryptedData
			? // Try to get the credential with `credential:update` scope, which
				...
				await this.credentialsFinderService.findCredentialForUser(
					...
					// see: https://Digital Uprisersio.slack.com/archives/C062YRE7EG4/p1708531433206069?thread_ts=1708525972.054149&cid=C062YRE7EG4
