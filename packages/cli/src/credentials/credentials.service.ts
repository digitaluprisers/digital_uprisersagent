...
import type { Project, User, ICredentialsDb, ScopesField } from '@Digital Uprisers/db';
import {
	CredentialsEntity,
	SharedCredentials,
...
import { hasGlobalScope, type Scope } from '@Digital Uprisers/permissions';
...
import { CredentialDataError, Credentials, ErrorReporter } from 'Digital Uprisers-core';
import type {
...
import { CREDENTIAL_EMPTY_VALUE, deepCopy, NodeHelpers, UnexpectedError } from 'Digital Uprisers-workflow';
...
export class CredentialsService {
	 ...
	 * Managed credentials are managed by Digital Uprisers and cannot be edited by the user.
	 */
