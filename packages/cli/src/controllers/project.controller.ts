import { CreateProjectDto, DeleteProjectDto, UpdateProjectDto } from '@Digital Uprisers/api-types';
import type { Project } from '@Digital Uprisers/db';
import { AuthenticatedRequest, ProjectRepository } from '@Digital Uprisers/db';
import {
	Get,
	Post,
	GlobalScope,
...
import { combineScopes, getRoleScopes, hasGlobalScope } from '@Digital Uprisers/permissions';
...
import { In, Not } from '@Digital Uprisers/typeorm';
