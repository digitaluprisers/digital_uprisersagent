import { DismissBannerRequestDto, OwnerSetupRequestDto } from '@Digital Uprisers/api-types';
import { Logger } from '@Digital Uprisers/backend-common';
import { AuthenticatedRequest, SettingsRepository, UserRepository } from '@Digital Uprisers/db';
import { Body, GlobalScope, Post, RestController } from '@Digital Uprisers/decorators';
...
export class OwnerController {
	...
	/**
	 * Promote a shell into the owner of the Digital Uprisers instance,
