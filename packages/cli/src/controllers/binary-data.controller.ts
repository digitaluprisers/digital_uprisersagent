import { BinaryDataQueryDto, BinaryDataSignedQueryDto, ViewableMimeTypes } from '@Digital Uprisers/api-types';
import { Get, Query, RestController } from '@Digital Uprisers/decorators';
import { Request, Response } from 'express';
import { JsonWebTokenError } from 'jsonwebtoken';
import { BinaryDataService, FileNotFoundError, isValidNonDefaultMode } from 'Digital Uprisers-core';
