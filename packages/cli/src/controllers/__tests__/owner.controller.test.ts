import type { DismissBannerRequestDto, OwnerSetupRequestDto } from '@Digital Uprisers/api-types';
...
import type { PublicUser, SettingsRepository } from '@Digital Uprisers/db';
