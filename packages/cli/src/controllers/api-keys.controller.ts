import { CreateApiKeyRequestDto, UpdateApiKeyRequestDto } from '@Digital Uprisers/api-types';
import { AuthenticatedRequest } from '@Digital Uprisers/db';
import { Body, Delete, Get, Param, Patch, Post, RestController } from '@Digital Uprisers/decorators';
import { getApiKeyScopesForRole } from '@Digital Uprisers/permissions';
