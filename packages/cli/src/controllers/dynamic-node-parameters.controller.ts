...
import { Post, RestController, Body } from '@Digital Uprisers/decorators';
import type { INodePropertyOptions, NodeParameterValueType } from 'Digital Uprisers-workflow';
