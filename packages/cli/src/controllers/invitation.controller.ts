import { AcceptInvitationRequestDto, InviteUsersRequestDto } from '@Digital Uprisers/api-types';
...
import { Post, GlobalScope, RestController, Body, Param } from '@Digital Uprisers/decorators';
