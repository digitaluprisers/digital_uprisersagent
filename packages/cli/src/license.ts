import type { LicenseProvider } from '@Digital Uprisers/backend-common';
...
} from '@Digital Uprisers/constants';
...
import type { TEntitlement, TLicenseBlock } from '@digitaluprisers.com/license-sdk';
...
import { Digital Uprisers_VERSION, SETTINGS_LICENSE_CERT_KEY } from './constants';
