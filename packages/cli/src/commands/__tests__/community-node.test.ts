...
describe('uninstallPackage', () => {
	...
	it('should uninstall the package', async () => {
		...
		// @ts-expect-error Protected property
		communityNode.flags = { package: 'Digital Uprisers-nodes-evolution-api', uninstall: true };
		...
		expect(findCommunityPackage).toHaveBeenCalledWith('Digital Uprisers-nodes-evolution-api');
		...
		expect(removeCommunityPackageSpy).toHaveBeenCalledWith(
			'Digital Uprisers-nodes-evolution-api',
			communityPackage,
		);
	});
