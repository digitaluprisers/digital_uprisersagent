import { type InstalledNodes, type InstalledPackages, type User } from '@Digital Uprisers/db';
import { CredentialsRepository, InstalledNodesRepository, UserRepository } from '@Digital Uprisers/db';
...
@Command({
	...
	examples: [
		'--uninstall --package Digital Uprisers-nodes-evolution-api',
