...
@Command({
	name: 'webhook',
	description: 'Starts Digital Uprisers webhook process. Intercepts only production URLs.',
})
export class Webhook extends BaseCommand {
	...
	/**
	 * Stops Digital Uprisers in a graceful way.
	...
	async init() {
		...
		this.logger.info('Starting Digital Uprisers webhook process...');
