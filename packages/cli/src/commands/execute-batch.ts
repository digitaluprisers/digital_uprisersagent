...
import type { IRun, ITaskData, IWorkflowBase, IWorkflowExecutionDataProcess } from 'Digital Uprisers-workflow';
...
export class ExecuteBatch extends BaseCommand<z.infer<typeof flagsSchema>> {
	...
	initializeLogs() {
		...
		process.stdout.write('              Digital Uprisers test workflows\n');
		process.stdout.write('**********************************************\n');
		process.stdout.write('\n');
