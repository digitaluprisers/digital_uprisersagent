...
import { WebhookPathTakenError, Workflow } from 'Digital Uprisers-workflow';
import type {
	IWebhookData,
 ...
 * that use the [Test URL](https://docs.digitaluprisers.com/integrations/builtin/core-nodes/Digital Uprisers-nodes-base.webhook/#webhook-urls).
 */
@Service()
export class TestWebhooks implements IWebhookManager {
	 ...
	 * `Workflow` from `Digital Uprisers-workflow`.
	 */
