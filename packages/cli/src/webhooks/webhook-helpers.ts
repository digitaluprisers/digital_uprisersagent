...
import { BinaryDataService, ErrorReporter } from 'Digital Uprisers-core';
import type {
	IBinaryData,
	IBinaryKeyData,
	IDataObject,
...
export function setupResponseNodePromise(
	responsePromise: IDeferredPromise<IDigital UprisersHttpFullResponse>,
	...
	void responsePromise.promise
		.then(async (response: IDigital UprisersHttpFullResponse) => {
...
export async function executeWebhook(
	...
	try {
		...
		let responsePromise: IDeferredPromise<IDigital UprisersHttpFullResponse> | undefined;
		if (responseMode === 'responseNode') {
			responsePromise = createDeferredPromise<IDigital UprisersHttpFullResponse>();
