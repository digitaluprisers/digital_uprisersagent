import { WebhookEntity } from '@Digital Uprisers/db';
import type { WebhookRepository } from '@Digital Uprisers/db';
import { mock } from 'jest-mock-extended';
import type { INode, INodeType, IWebhookData, IWorkflowExecuteAdditionalData } from 'Digital Uprisers-workflow';
