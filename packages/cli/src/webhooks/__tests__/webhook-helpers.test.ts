...
import { createDeferredPromise, FORM_NODE_TYPE, WAIT_NODE_TYPE } from 'Digital Uprisers-workflow';
...
describe('setupResponseNodePromise', () => {
	...
	let responsePromise: IDeferredPromise<IDigital UprisersHttpFullResponse>;
