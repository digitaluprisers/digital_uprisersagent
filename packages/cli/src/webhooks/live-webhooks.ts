...
import { Workflow, CHAT_TRIGGER_NODE_TYPE } from 'Digital Uprisers-workflow';
import type { INode, IWebhookData, IHttpRequestMethods } from 'Digital Uprisers-workflow';
 ...
 * (https://docs.digitaluprisers.com/integrations/builtin/core-nodes/Digital Uprisers-nodes-base.webhook/#webhook-urls)
 */
@Service()
