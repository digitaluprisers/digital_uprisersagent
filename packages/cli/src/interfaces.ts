import type { ICredentialsBase, IExecutionBase, IExecutionDb, ITagBase } from '@Digital Uprisers/db';
import type { AssignableGlobalRole } from '@Digital Uprisers/permissions';
...
export interface Digital UprisersApp {
	app: Application;
	restEndpoint: string;
