...
import type { TaskRunnersConfig } from '@Digital Uprisers/config';
import { Time } from '@Digital Uprisers/constants';
import type { RunnerMessage, TaskResultData } from '@Digital Uprisers/task-runner';
import { mock } from 'jest-mock-extended';
import { ApplicationError, type INodeTypeBaseDescription } from 'Digital Uprisers-workflow';
...
describe('TaskBroker', () => {
	...
	describe('onRunnerMessage', () => {
		...
		it('should handle `runner:nodetypesrequest` message', async () => {
			...
			const requestParams = [
				{
					name: 'Digital Uprisers-nodes-base.someNode',
					version: 1,
				},
			];
