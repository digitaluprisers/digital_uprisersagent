...
import { In, type FindOptionsRelations } from '@Digital Uprisers/typeorm';
...
export class WorkflowsController {
	...
	async getFromUrl(
		...
		// Do a very basic check if it is really a Digital Uprisers-workflow-json
		if (
			...
			throw new BadRequestError(
				'The data in the file does not seem to be a Digital Uprisers workflow JSON file!',
			);
		}
