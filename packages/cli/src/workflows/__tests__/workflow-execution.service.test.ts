...
import type { Project, User, WorkflowEntity, WorkflowRepository } from '@Digital Uprisers/db';
...
describe('WorkflowExecutionService', () => {
	...
	describe('executeManually()', () => {
		...
		[
			{
				name: 'trigger',
				type: 'Digital Uprisers-nodes-base.airtableTrigger',
	...
	describe('executeErrorWorkflow()', () => {
		test('should call `WorkflowRunner.run()` with correct parameters', async () => {
			...
			const errorTriggerType = 'Digital Uprisers-nodes-base.errorTrigger';
