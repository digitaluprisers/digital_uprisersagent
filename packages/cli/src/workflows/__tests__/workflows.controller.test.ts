import type { ImportWorkflowFromUrlDto } from '@Digital Uprisers/api-types/src/dto/workflows/import-workflow-from-url.dto';
...
describe('WorkflowsController', () => {
	...
	describe('getFromUrl', () => {
		...
		describe('should throw a BadRequestError', () => {
			...
			it('when the data is not a valid Digital Uprisers workflow JSON', async () => {
