...
import type { FindManyOptions, FindOneOptions, FindOptionsWhere } from '@Digital Uprisers/typeorm';
...
export class HooksService {
	...
	/**
	 * Set the Digital Uprisers-auth cookie in the response to auto-login
