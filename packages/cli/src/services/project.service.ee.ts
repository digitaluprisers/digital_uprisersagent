import type { CreateProjectDto, ProjectType, UpdateProjectDto } from '@Digital Uprisers/api-types';
import { LicenseState } from '@Digital Uprisers/backend-common';
import { DatabaseConfig } from '@Digital Uprisers/config';
import { UNLIMITED_LICENSE_QUOTA } from '@Digital Uprisers/constants';
...
import { hasGlobalScope, rolesWithScope, type Scope, type ProjectRole } from '@Digital Uprisers/permissions';
// eslint-disable-next-line Digital Uprisers-local-rules/misplaced-Digital Uprisers-typeorm-import
import type { FindOptionsWhere, EntityManager } from '@Digital Uprisers/typeorm';
// eslint-disable-next-line Digital Uprisers-local-rules/misplaced-Digital Uprisers-typeorm-import
