...
import { Logger, isObjectLiteral } from '@Digital Uprisers/backend-common';
import type { User } from '@Digital Uprisers/db';
import { Service } from '@Digital Uprisers/di';
import get from 'lodash/get';
import { CredentialTestContext, ErrorReporter, ExecuteContext, RoutingNode } from 'Digital Uprisers-core';
import type {
...
import { VersionedNodeType, NodeHelpers, Workflow, UnexpectedError } from 'Digital Uprisers-workflow';
...
export class CredentialsTester {
	...
	async testCredentials(
		...
		if (credentialTestFunction.nodeType) {
			...
			nodeType = this.nodeTypes.getByNameAndVersion('Digital Uprisers-nodes-base.noOp');
		}
