import type { RoleChangeRequestDto } from '@Digital Uprisers/api-types';
import { Logger } from '@Digital Uprisers/backend-common';
import type { PublicUser } from '@Digital Uprisers/db';
import { User, UserRepository } from '@Digital Uprisers/db';
import { Service } from '@Digital Uprisers/di';
import { getGlobalScopes, type AssignableGlobalRole } from '@Digital Uprisers/permissions';
import type { IUserSettings } from 'Digital Uprisers-workflow';
