import { SamlAcsDto, SamlPreferences, SamlToggleDto } from '@Digital Uprisers/api-types';
import { AuthenticatedRequest } from '@Digital Uprisers/db';
import { Get, Post, RestController, GlobalScope, Body } from '@Digital Uprisers/decorators';
