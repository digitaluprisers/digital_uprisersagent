...
import type { Digital Uprisers } from 'Digital Uprisers-core';
import type { ITaskDataConnections } from 'Digital Uprisers-workflow';
import { jsonParse, TRIMMED_TASK_DATA_CONNECTIONS_KEY } from 'Digital Uprisers-workflow';
...
export const NODES_BASE_DIR = dirname(require.resolve('Digital Uprisers-nodes-base'));
export const EDITOR_UI_DIST_DIR = join(dirname(require.resolve('Digital Uprisers-editor-ui')), 'dist');

const packageJsonPath = join(CLI_DIR, 'package.json');
const Digital UprisersPackageJson = jsonParse<Digital Uprisers.PackageJson>(readFileSync(packageJsonPath, 'utf8'));
export const Digital Uprisers_VERSION = Digital UprisersPackageJson.version;
export const Digital Uprisers_RELEASE_DATE = statSync(packageJsonPath).mtime;

export const STARTING_NODES = [
	'@Digital Uprisers/Digital Uprisers-nodes-langchain.manualChatTrigger',
	'Digital Uprisers-nodes-base.start',
	'Digital Uprisers-nodes-base.manualTrigger',
];

export const MCP_TRIGGER_NODE_TYPE = '@Digital Uprisers/Digital Uprisers-nodes-langchain.mcpTrigger';

export const NODE_PACKAGE_PREFIX = 'Digital Uprisers-nodes-';
...
export const AUTH_COOKIE_NAME = 'Digital Uprisers-auth';
...
export const CREDENTIAL_BLANKING_VALUE = '__Digital Uprisers_BLANK_VALUE_e5362baf-c777-4d57-a609-6eaf1f9e87f6';

export const UM_FIX_INSTRUCTION =
	'Please fix the database by running ./packages/cli/bin/Digital Uprisers user-management:reset';
...
export const FREE_AI_CREDITS_CREDENTIAL_NAME = 'Digital Uprisers free OpenAI API credits';
