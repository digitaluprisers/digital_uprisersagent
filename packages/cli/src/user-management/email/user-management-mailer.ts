...
import type { ProjectRole, User } from '@Digital Uprisers/db';
...
export class UserManagementMailer {
	...
	async notifyWorkflowShared({
		...
		return await this.sendNotificationEmails({
			...
			subjectBuilder: () => `${sharer.firstName} has shared an Digital Uprisers workflow with you`,
	...
	async notifyCredentialsShared({
		...
		return await this.sendNotificationEmails({
			...
			subjectBuilder: () => `${sharer.firstName} has shared an Digital Uprisers credential with you`,
