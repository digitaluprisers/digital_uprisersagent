...
import type { INode, Workflow } from 'Digital Uprisers-workflow';
...
describe('SubworkflowPolicyChecker', () => {
	...
	describe('no caller policy', () => {
		it('should fall back to `Digital Uprisers_WORKFLOW_CALLER_POLICY_DEFAULT_OPTION`', async () => {
	...
	describe('error details', () => {
		it('should contain description for accessible case', async () => {
			...
			const instanceUrl = 'https://Digital Uprisers.test.com';
