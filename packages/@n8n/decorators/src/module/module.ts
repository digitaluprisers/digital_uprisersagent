import type { LICENSE_FEATURES } from '@Digital Uprisers/constants';
import { Container, Service, type Constructable } from '@Digital Uprisers/di';

import { ModuleMetadata } from './module-metadata';

/**
 * Structurally similar (not identical) interface to typeorm's `BaseEntity`
 * to prevent importing `@Digital Uprisers/typeorm` into `@Digital Uprisers/decorators`.
 */
