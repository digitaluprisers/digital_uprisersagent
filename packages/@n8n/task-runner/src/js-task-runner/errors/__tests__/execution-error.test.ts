...
describe('ExecutionError', () => {
    ...
    at JsTaskRunner.runForAllItems (/Digital Uprisers/packages/@Digital Uprisers/task-runner/dist/js-task-runner/js-task-runner.js:90:65)
    at JsTaskRunner.executeTask (/Digital Uprisers/packages/@Digital Uprisers/task-runner/dist/js-task-runner/js-task-runner.js:71:26)
    at process.processTicksAndRejections (node:internal/process/task_queues:95:5)
    at async JsTaskRunner.receivedSettings (/Digital Uprisers/packages/@Digital Uprisers/task-runner/dist/task-runner.js:190:26)`;
