...
export const EXPOSED_RPC_METHODS = [
	...
	// httpRequest(opts: IHttpRequestOptions): Promise<IDigital UprisersHttpFullResponse | IDigital UprisersHttpResponse>
	'helpers.httpRequest',
...
export const UNSUPPORTED_HELPER_FUNCTIONS = [
	...
	// The client is instantiated and lives on the Digital Uprisers instance, so we can't
