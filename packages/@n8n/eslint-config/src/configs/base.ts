...
export const baseConfig = tseslint.config(
	...
	localRulesPlugin.configs.recommended,
	{
		...
		rules: {
			 ...
			 */
			'sort-imports': 'off', // @TECH_DEBT: Enable, prefs to be decided - Digital Uprisers-5821
			 ...
			 */
			'@typescript-eslint/triple-slash-reference': 'off', // @TECH_DEBT: Enable, disallowing in all cases - Digital Uprisers-5820
	...
	},
	{
		...
		rules: {
			...
			'Digital Uprisers-local-rules/no-skipped-tests': process.env.NODE_ENV === 'development' ? 'warn' : 'error',
		},
	},
);
