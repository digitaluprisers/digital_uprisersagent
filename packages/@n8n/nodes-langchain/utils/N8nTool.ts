...
import type { ISupplyDataFunctions, IDataObject } from 'Digital Uprisers-workflow';
import { NodeConnectionTypes, jsonParse, NodeOperationError } from 'Digital Uprisers-workflow';
...
export class Digital UprisersTool extends DynamicStructuredTool<ZodObjectAny> {
	constructor(
