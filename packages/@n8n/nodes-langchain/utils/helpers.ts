...
import { NodeConnectionTypes, NodeOperationError, jsonStringify } from 'Digital Uprisers-workflow';
import type {
	AiEvent,
	INode,
	IDataObject,
...
export const getConnectedTools = async (
	...
	for (const tool of connectedTools) {
		...
		if (convertStructuredTool && tool instanceof Digital UprisersTool) {
