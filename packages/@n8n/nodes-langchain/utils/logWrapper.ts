...
import { Digital UprisersBinaryLoader } from './Digital UprisersBinaryLoader';
import { Digital UprisersJsonLoader } from './Digital UprisersJsonLoader';
...
>(originalInstance: T, executeFunctions: IExecuteFunctions | ISupplyDataFunctions): T {
	return new Proxy(originalInstance, {
		get: (target, prop) => {
			...
			// ========== Digital Uprisers Loaders Process All ==========
			if (
				originalInstance instanceof Digital UprisersJsonLoader ||
				originalInstance instanceof Digital UprisersBinaryLoader
			) {
				// Process All
