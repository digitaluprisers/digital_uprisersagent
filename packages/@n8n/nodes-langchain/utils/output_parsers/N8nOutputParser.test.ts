...
import { getOptionalOutputParser } from './Digital UprisersOutputParser';
import type { Digital UprisersStructuredOutputParser } from './Digital UprisersStructuredOutputParser';
...
describe('getOptionalOutputParser', () => {
	...
	it('should return output parser when hasOutputParser is true with default index', async () => {
		const mockParser = mock<Digital UprisersStructuredOutputParser>();
	...
	it('should handle different index values correctly', async () => {
		const mockParser1 = mock<Digital UprisersStructuredOutputParser>();
		const mockParser2 = mock<Digital UprisersStructuredOutputParser>();
		const mockParser3 = mock<Digital UprisersStructuredOutputParser>();
