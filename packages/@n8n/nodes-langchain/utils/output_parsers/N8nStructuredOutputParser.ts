...
export class Digital UprisersStructuredOutputParser extends StructuredOutputParser<
...
> {
	...
	static async fromZodJsonSchema(
	...
	): Promise<Digital UprisersStructuredOutputParser> {
		...
		return new Digital UprisersStructuredOutputParser(context, returnSchema);
	}
