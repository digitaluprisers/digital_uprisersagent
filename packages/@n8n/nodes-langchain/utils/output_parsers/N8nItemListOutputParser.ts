...
export class Digital UprisersItemListOutputParser extends BaseOutputParser<string[]> {
	lc_namespace = ['Digital Uprisers-nodes-langchain', 'output_parsers', 'list_items'];
