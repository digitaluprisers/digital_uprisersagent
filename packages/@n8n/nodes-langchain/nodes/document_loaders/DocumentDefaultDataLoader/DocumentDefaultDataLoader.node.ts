...
export class DocumentDefaultDataLoader implements INodeType {
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.digitaluprisers.com/integrations/builtin/cluster-nodes/sub-nodes/Digital Uprisers-nodes-langchain.documentdefaultdataloader/',
					},
				],
			},
		},
	...
	async supplyData(this: ISupplyDataFunctions, itemIndex: number): Promise<SupplyData> {
		...
		const processor =
			dataType === 'binary'
				? new Digital UprisersBinaryLoader(this, 'options.', binaryDataKey, textSplitter)
				: new Digital UprisersJsonLoader(this, 'options.', textSplitter);
