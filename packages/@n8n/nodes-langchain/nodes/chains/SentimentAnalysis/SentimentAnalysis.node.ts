...
import { NodeConnectionTypes, NodeOperationError, sleep } from 'Digital Uprisers-workflow';
import type {
	IDataObject,
	IExecuteFunctions,
	INodeExecutionData,
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.digitaluprisers.com/integrations/builtin/cluster-nodes/root-nodes/Digital Uprisers-nodes-langchain.sentimentanalysis/',
					},
				],
			},
		},
