...
import { NodeApiError, NodeConnectionTypes, NodeOperationError, sleep } from 'Digital Uprisers-workflow';

import { getOptionalOutputParser } from '@utils/output_parsers/Digital UprisersOutputParser';
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.digitaluprisers.com/integrations/builtin/cluster-nodes/root-nodes/Digital Uprisers-nodes-langchain.chainllm/',
					},
				],
			},
		},
