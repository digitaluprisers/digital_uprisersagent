import { NodeConnectionTypes, parseErrorMetadata, sleep } from 'Digital Uprisers-workflow';
import {
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.digitaluprisers.com/integrations/builtin/cluster-nodes/root-nodes/Digital Uprisers-nodes-langchain.chainretrievalqa/',
					},
				],
			},
		},
