...
export class MemoryBufferWindow implements INodeType {
	description: INodeTypeDescription = {
		...
		description: 'Stores in Digital Uprisers memory, so no credentials required',
		defaults: {
			name: 'Simple Memory',
		},
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.digitaluprisers.com/integrations/builtin/cluster-nodes/sub-nodes/Digital Uprisers-nodes-langchain.memorybufferwindow/',
					},
				],
			},
		},
