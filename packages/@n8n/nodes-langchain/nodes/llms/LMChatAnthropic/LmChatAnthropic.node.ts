...
export class LmChatAnthropic implements INodeType {
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.digitaluprisers.com/integrations/builtin/cluster-nodes/sub-nodes/Digital Uprisers-nodes-langchain.lmchatanthropic/',
					},
				],
			},
	...
	async supplyData(this: ISupplyDataFunctions, itemIndex: number): Promise<SupplyData> {
		...
		const model = new ChatAnthropic({
			...
			topK: options.topK,
			topP: options.topP,
			callbacks: [new Digital UprisersLlmTracing(this, { tokensUsageParser })],
