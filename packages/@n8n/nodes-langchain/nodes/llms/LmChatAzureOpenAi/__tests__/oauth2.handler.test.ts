...
// Mock the Digital UprisersOAuth2TokenCredential
jest.mock('../credentials/Digital UprisersOAuth2TokenCredential', () => ({
	Digital UprisersOAuth2TokenCredential: jest.fn().mockImplementation(() => ({
