...
import type { ClientOAuth2TokenData } from '@Digital Uprisers/client-oauth2';
...
/**
 * Adapts Digital Uprisers's credential retrieval into the TokenCredential interface expected by @azure/identity
 */
export class Digital UprisersOAuth2TokenCredential implements TokenCredential {
	constructor(
		private node: INode,
