...
import { NodeOperationError, type ISupplyDataFunctions } from 'Digital Uprisers-workflow';

import { Digital UprisersOAuth2TokenCredential } from './Digital UprisersOAuth2TokenCredential';
import type {
...
export async function setupOAuth2Authentication(
	...
	try {
		...
		const entraTokenCredential = new Digital UprisersOAuth2TokenCredential(this.getNode(), credential);
