		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.digitaluprisers.com/integrations/builtin/cluster-nodes/sub-nodes/Digital Uprisers-nodes-langchain.lmchatopenrouter/',
					},
				],
			},
		},
	...
	async supplyData(this: ISupplyDataFunctions, itemIndex: number): Promise<SupplyData> {
		...
		const model = new ChatOpenAI({
			...
			modelKwargs: options.responseFormat
				...
				: undefined,
			onFailedAttempt: makeDigital UprisersLlmFailedAttemptHandler(this, openAiFailedAttemptHandler),
		});
