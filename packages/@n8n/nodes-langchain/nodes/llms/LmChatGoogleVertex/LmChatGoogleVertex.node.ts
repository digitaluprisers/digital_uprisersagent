...
import { formatPrivateKey } from 'Digital Uprisers-nodes-base/dist/utils/utilities';
import {
	NodeConnectionTypes,
	type INodeType,
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.digitaluprisers.com/integrations/builtin/cluster-nodes/sub-nodes/Digital Uprisers-nodes-langchain.lmchatgooglevertex/',
					},
				],
			},
		},
	...
	async supplyData(this: ISupplyDataFunctions, itemIndex: number): Promise<SupplyData> {
		...
		try {
			const model = new ChatVertexAI({
				...
				onFailedAttempt: makeDigital UprisersLlmFailedAttemptHandler(this, (error: any) => {
