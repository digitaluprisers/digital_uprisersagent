...
import type { ISupplyDataFunctions, JsonObject } from 'Digital Uprisers-workflow';
 ...
 */
export const makeDigital UprisersLlmFailedAttemptHandler = (
	...
	return (error: any) => {
		try {
			...
			Digital UprisersDefaultFailedAttemptHandler(error);
		} catch (e) {
