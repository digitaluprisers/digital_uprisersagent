...
import type { IDataObject, ISupplyDataFunctions, JsonObject } from 'Digital Uprisers-workflow';
import { NodeConnectionTypes, NodeError, NodeOperationError } from 'Digital Uprisers-workflow';
...
export class Digital UprisersNonEstimatingTracing extends BaseCallbackHandler {
	name = 'Digital UprisersNonEstimatingTracing';
