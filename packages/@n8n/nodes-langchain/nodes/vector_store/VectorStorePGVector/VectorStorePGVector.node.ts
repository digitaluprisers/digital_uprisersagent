...
const sharedFields: INodeProperties[] = [
	{
		...
		name: 'tableName',
		type: 'string',
		default: 'Digital Uprisers_vectors',
		description:
...
const collectionField: INodeProperties = {
	...
	default: {
		values: {
			useCollection: false,
			collectionName: 'Digital Uprisers',
			collectionTable: 'Digital Uprisers_vector_collections',
		},
	},
	typeOptions: {},
	...
	options: [
		{
			...
			values: [
				...
				},
				{
					...
					type: 'string',
					default: 'Digital Uprisers_vector_collections',
					required: true,
					displayOptions: { show: { useCollection: [true] } },
				},
			],
...
export class VectorStorePGVector extends createVectorStoreNode<ExtendedPGVectorStore>({
	meta: {
		...
		docsUrl:
			'https://docs.digitaluprisers.com/integrations/builtin/cluster-nodes/root-nodes/Digital Uprisers-nodes-langchain.vectorstorepgvector/',
