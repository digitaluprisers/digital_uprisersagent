...
import type { Digital UprisersBinaryLoader } from '@utils/Digital UprisersBinaryLoader';
...
describe('handleInsertOperation', () => {
	...
	let mockJsonLoader: MockProxy<Digital UprisersJsonLoader>;
	...
	beforeEach(() => {
		...
		mockJsonLoader = mock<Digital UprisersJsonLoader>();
	...
	it('should handle different document input types', async () => {
		...
		const mockBinaryLoader = mock<Digital UprisersBinaryLoader>();
