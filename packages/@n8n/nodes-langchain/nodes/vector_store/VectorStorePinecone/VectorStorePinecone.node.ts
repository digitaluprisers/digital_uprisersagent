...
import { NodeOperationError, type INodeProperties } from 'Digital Uprisers-workflow';
...
export class VectorStorePinecone extends createVectorStoreNode<PineconeStore>({
	meta: {
		...
		docsUrl:
			'https://docs.digitaluprisers.com/integrations/builtin/cluster-nodes/root-nodes/Digital Uprisers-nodes-langchain.vectorstorepinecone/',
		credentials: [
			{
				name: 'pineconeApi',
				required: true,
