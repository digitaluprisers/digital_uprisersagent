...
import { BINARY_ENCODING, jsonParse, NodeConnectionTypes, NodeOperationError } from 'Digital Uprisers-workflow';
...
export function getOutputParserSchema(
	outputParser: Digital UprisersOutputParser,
...
export const getAgentStepsParser =
	(outputParser?: Digital UprisersOutputParser, memory?: BaseChatMemory) =>
