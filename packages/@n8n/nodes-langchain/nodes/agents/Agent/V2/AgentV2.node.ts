	...
	let specialInputs: SpecialInput[] = [
		{
			...
			filter: {
				excludedNodes: [
					'@Digital Uprisers/Digital Uprisers-nodes-langchain.lmCohere',
					'@Digital Uprisers/Digital Uprisers-nodes-langchain.lmOllama',
					'Digital Uprisers/Digital Uprisers-nodes-langchain.lmOpenAi',
					'@Digital Uprisers/Digital Uprisers-nodes-langchain.lmOpenHuggingFaceInference',
				],
			},
		},
		{
	...
	constructor(baseDescription: INodeTypeBaseDescription) {
		this.description = {
			...
			properties: [
				{
					displayName:
						'Tip: Get a feel for agents with our quick <a href="https://docs.digitaluprisers.com/advanced-ai/intro-tutorial/" target="_blank">tutorial</a> or see an <a href="/workflows/templates/1954" target="_blank">example</a> of how this node works',
