...
import { NodeOperationError, updateDisplayOptions } from 'Digital Uprisers-workflow';
...
const properties: INodeProperties[] = [
	...
	{
		displayName:
			'Add custom Digital Uprisers tools when you <i>message</i> your assistant (rather than when creating it)',
		name: 'noticeTools',
		type: 'notice',
		default: '',
	},
