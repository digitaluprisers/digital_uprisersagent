...
import { jsonParse, updateDisplayOptions } from 'Digital Uprisers-workflow';
...
const properties: INodeProperties[] = [
	...
	{
		displayName: 'Connect your own custom Digital Uprisers tools to this node on the canvas',
		name: 'noticeTools',
		type: 'notice',
		default: '',
		displayOptions: {
