...
export const authenticationProperties: INodeProperties[] = [
	{
		...
		name: 'authentication',
		description:
			'Select the type of authentication to use if needed, authentication would be done by Digital Uprisers and your credentials will not be shared with the LLM',
