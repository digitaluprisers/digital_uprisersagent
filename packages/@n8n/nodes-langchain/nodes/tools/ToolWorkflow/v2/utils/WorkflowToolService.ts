...
import { getCurrentWorkflowInputData } from 'Digital Uprisers-nodes-base/dist/utils/workflowInputsResourceMapping/GenericFunctions';
import type {
	ExecuteWorkflowData,
	ExecutionError,
	FromAIArgument,
...
/**
	...
	Processes the node parameters and creates AI Agent tool capable of executing Digital Uprisers workflows
*/
