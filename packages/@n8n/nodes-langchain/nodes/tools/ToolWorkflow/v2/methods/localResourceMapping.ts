import { loadWorkflowInputMappings } from 'Digital Uprisers-nodes-base/dist/utils/workflowInputsResourceMapping/GenericFunctions';
import type { ILocalLoadOptionsFunctions, ResourceMapperFields } from 'Digital Uprisers-workflow';
