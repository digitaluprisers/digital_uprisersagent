...
export const versionDescription: INodeTypeDescription = {
	displayName: 'Call Digital Uprisers Workflow Tool',
	name: 'toolWorkflow',
	group: ['transform'],
	version: [1, 1.1, 1.2, 1.3],
	description: 'Uses another Digital Uprisers workflow as a tool. Allows packaging any Digital Uprisers node(s) as a tool.',
	defaults: {
		name: 'Call Digital Uprisers Workflow Tool',
	},
	codex: {
		categories: ['AI'],
		subcategories: {
	...
	properties: [
		...
		// ----------------------------------
		{
			...
			description:
				'Where to find the data that this tool should return. Digital Uprisers will look in the output of the last-executed node of the workflow for a field with this name, and return its value.',
			displayOptions: {
				show: {
					'@version': [{ _cnd: { lt: 1.3 } }],
				},
