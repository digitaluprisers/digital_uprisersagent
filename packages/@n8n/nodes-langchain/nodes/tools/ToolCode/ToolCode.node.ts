...
import { PythonSandbox } from 'Digital Uprisers-nodes-base/dist/nodes/Code/PythonSandbox';
import type { Sandbox } from 'Digital Uprisers-nodes-base/dist/nodes/Code/Sandbox';
	...
	description: INodeTypeDescription = {
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.digitaluprisers.com/integrations/builtin/cluster-nodes/sub-nodes/Digital Uprisers-nodes-langchain.toolcode/',
					},
				],
			},
		},
		...
		properties: [
			...
			},
			{
				...
				// eslint-disable-next-line Digital Uprisers-nodes-base/node-param-description-missing-final-period
