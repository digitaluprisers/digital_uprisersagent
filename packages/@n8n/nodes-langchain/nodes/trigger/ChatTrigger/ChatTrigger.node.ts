...
import { Node, NodeConnectionTypes } from 'Digital Uprisers-workflow';
import type {
	IDataObject,
	IWebhookFunctions,
...
export class ChatTrigger extends Node {
	description: INodeTypeDescription = {
		...
		defaultVersion: 1.1,
		description: 'Runs the workflow when an Digital Uprisers generated webchat is submitted',
		defaults: {
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.digitaluprisers.com/integrations/builtin/core-nodes/Digital Uprisers-nodes-langchain.chattrigger/',
					},
				],
			},
		},
		...
		credentials: [
			{
				// eslint-disable-next-line Digital Uprisers-nodes-base/node-class-description-credentials-name-unsuffixed
				name: 'httpBasicAuth',
				required: true,
				displayOptions: {
					show: {
		...
		properties: [
				...
				options: [
					{
						name: 'Hosted Chat',
						value: 'hostedChat',
						description: 'Chat on a page served by Digital Uprisers',
					},
					{
						name: 'Embedded Chat',
						value: 'webhook',
			...
			{
				displayName:
					'Follow the instructions <a href="https://www.npmjs.com/package/@Digital Uprisers/chat" target="_blank">here</a> to embed chat in a webpage (or just call the webhook URL at the top of this section). Chat will be live once you activate this workflow',
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						name: 'Digital Uprisers User Auth',
						value: 'Digital UprisersUserAuth',
						description: 'Require user to be logged in with their Digital Uprisers account',
					},
					{
						name: 'None',
						value: 'none',
