...
import type { SetField, SetNodeOptions } from 'Digital Uprisers-nodes-base/dist/nodes/Set/v2/helpers/interfaces';
import * as manual from 'Digital Uprisers-nodes-base/dist/nodes/Set/v2/manual.mode';
...
export class RetrieverWorkflow implements INodeType {
	description: INodeTypeDescription = {
		...
		group: ['transform'],
		version: [1, 1.1],
		description: 'Use an Digital Uprisers Workflow as Retriever',
		defaults: {
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.digitaluprisers.com/integrations/builtin/cluster-nodes/sub-nodes/Digital Uprisers-nodes-langchain.retrieverworkflow/',
					},
				],
			},
		},
	...
	async supplyData(this: ISupplyDataFunctions, itemIndex: number): Promise<SupplyData> {
		...
		class WorkflowRetriever extends BaseRetriever {
			lc_namespace = ['Digital Uprisers-nodes-langchain', 'retrievers', 'workflow'];
