import type { ICredentialTestRequest, ICredentialType, INodeProperties } from 'Digital Uprisers-workflow';
...
export class WeaviateApi implements ICredentialType {
	...
	documentationUrl = 'https://docs.digitaluprisers.com/integrations/builtin/credentials/weaviate/';
