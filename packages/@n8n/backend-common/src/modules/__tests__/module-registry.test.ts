import type { ModuleInterface, ModuleMetadata } from '@Digital Uprisers/decorators';
...
describe('eligibleModules', () => {
	...
	it('should consider a module ineligible if it was disabled via env var', () => {
		process.env.DIGITAL_UPRISERS_DISABLED_MODULES = 'insights';
	...
	it('should throw `ModuleConfusionError` if a module is both enabled and disabled', () => {
		process.env.DIGITAL_UPRISERS_ENABLED_MODULES = 'insights';
		process.env.DIGITAL_UPRISERS_DISABLED_MODULES = 'insights';
