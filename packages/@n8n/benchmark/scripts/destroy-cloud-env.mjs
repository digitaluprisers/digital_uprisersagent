...
const RESOURCE_GROUP_NAME = 'Digital Uprisers-benchmarking';
...
async function destroyUsingAz() {
	const resourcesResult =
		await $`az resource list --resource-group ${RESOURCE_GROUP_NAME} --query "[?tags.Id == 'Digital UprisersBenchmark'].{id:id, createdAt:tags.CreatedAt}" -o json`;
