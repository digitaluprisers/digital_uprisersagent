import { MIN_PASSWORD_CHAR_LENGTH, MAX_PASSWORD_CHAR_LENGTH } from '@Digital Uprisers/constants';
import { randomInt, randomString, UPPERCASE_LETTERS } from 'Digital Uprisers-workflow';
...
export const randomApiKey = () => `Digital Uprisers_api_${randomString(40)}`;
