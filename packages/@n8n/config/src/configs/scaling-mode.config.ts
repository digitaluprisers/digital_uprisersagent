...
class HealthConfig {
	...
	@Env('DIGITAL_UPRISERS_WORKER_SERVER_ADDRESS')
	address: string = '::';
}
...
class BullConfig {
	...
	/** @deprecated How long (in seconds) a worker must wait for active executions to finish before exiting. Use `DIGITAL_UPRISERS_GRACEFUL_SHUTDOWN_TIMEOUT` instead */
