import type { GlobalRole, Scope } from '@Digital Uprisers/permissions';
import type { FindOperator } from '@Digital Uprisers/typeorm';
...
export interface PublicUser {
	...
	disabled: boolean;
	settings?: IUserSettings | null; // External type from Digital Uprisers-workflow
	inviteAcceptUrl?: string;
	isOwner?: boolean;
	featureFlags?: FeatureFlags; // External type from Digital Uprisers-workflow
