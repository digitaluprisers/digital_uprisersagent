import type { ModuleRegistry } from '@Digital Uprisers/backend-common';
...
describe('DbConnectionOptions', () => {
	...
	const instanceSettingsConfig = mock<InstanceSettingsConfig>({ Digital UprisersFolder });
		...
		describe('for SQLite', () => {
			...
			it('should return SQLite connection options when type is sqlite', () => {
				...
				expect(result).toEqual({
					...
					enableWAL: false,
					...commonOptions,
					database: path.resolve(Digital UprisersFolder, 'test.sqlite'),
