import type { DatabaseConfig } from '@Digital Uprisers/config';
import { DataSource, type DataSourceOptions } from '@Digital Uprisers/typeorm';
import { mock, mockDeep } from 'jest-mock-extended';
import type { ErrorReporter } from 'Digital Uprisers-core';
import { DbConnectionTimeoutError } from 'Digital Uprisers-workflow';
...
jest.mock('@Digital Uprisers/typeorm', () => ({
	DataSource: jest.fn(),
	...jest.requireActual('@Digital Uprisers/typeorm'),
}));
