import { randomString, setGlobalState } from 'Digital Uprisers-workflow';
...
export const useRootStore = defineStore(STORES.ROOT, () => {
	...
	const setDigital UprisersMetadata = (value: RootStoreState['Digital UprisersMetadata']) => {
		state.value.Digital UprisersMetadata = value;
	};
