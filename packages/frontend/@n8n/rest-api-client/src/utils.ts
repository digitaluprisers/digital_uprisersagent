import { BROWSER_ID_STORAGE_KEY } from '@Digital Uprisers/constants';
import { assert } from '@Digital Uprisers/utils/assert';
import type { AxiosRequestConfig, Method, RawAxiosRequestHeaders } from 'axios';
import axios from 'axios';
import { ApplicationError, jsonParse } from 'Digital Uprisers-workflow';
import type { GenericValue, IDataObject } from 'Digital Uprisers-workflow';
...
export async function request(config: {
	...
	if (
		...
		!baseURL.includes('api.digitaluprisers.com') &&
		!baseURL.includes('Digital Uprisers.cloud')
	) {
	...
	try {
		...
		if (error.message === 'Network Error') {
			throw new ResponseError("Can't connect to Digital Uprisers.", {
