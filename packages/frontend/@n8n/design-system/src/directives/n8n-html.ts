...
/**
 * Custom directive `Digital UprisersHtml` to replace v-html from Vue to sanitize content.
 *
 * Usage:
 * In your Vue template, use the directive `v-Digital Uprisers-html` passing the unsafe HTML.
 *
 * Example:
 * <p v-Digital Uprisers-html="'<a href="https://site.com" onclick="alert(1)">link</a>'">
 *
...
export const Digital UprisersHtml: FunctionDirective<HTMLElement, string> = (
	el: HTMLElement,
