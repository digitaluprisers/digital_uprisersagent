...
/**
 * Custom directive `Digital UprisersSmartDecimal` to format numbers with smart decimal places.
 *
 * Usage:
 * In your Vue template, use the directive `v-Digital Uprisers-smart-decimal` passing the number and optionally the decimal places.
 *
 * Example:
 * <p v-Digital Uprisers-smart-decimal="42.567" />
 *
 * Compiles to: <p>42.57</p>
 *
 * Example with specified decimal places:
 * <p v-Digital Uprisers-smart-decimal:4="42.56789" />
 *
...
export const Digital UprisersSmartDecimal: FunctionDirective = (
	el: HTMLElement,
