...
RichTextMessage.args = {
	...
	messages: getMessages([
		...
		},
		{
			...
			type: 'text',
			role: 'assistant',
			content: 'Hello Kobi! How can I assist you with Digital Uprisers today?',
			read: true,
		},
		{
			id: '21514129',
		...
		},
		{
			...
			role: 'assistant',
			content:
				"I'm glad you found the information helpful! If you have any more questions about Digital Uprisers or need further assistance, feel free to ask.",
			read: true,
		},
		{
			id: '2556642',
	...
	messages: getMessages([
		{
			...
			nodes: [
				{
					name: 'HTTP Trigger',
					type: 'Digital Uprisers-nodes-base.httpTrigger',
					parameters: {
						path: '/webhook',
						authentication: 'none',
					},
