...
import type { IconSize } from '@Digital Uprisers/design-system/types';
import type { ButtonProps } from '@Digital Uprisers/design-system/types/button';

import Digital UprisersIcon from '../Digital UprisersIcon';
import Digital UprisersSpinner from '../Digital UprisersSpinner';

const $style = useCssModule();
const attrs = useAttrs();

defineOptions({ name: 'Digital UprisersButton' });
...
watchEffect(() => {
	if (props.element === 'a' && !props.href) {
		console.error('Digital Uprisers-button:href is required for link buttons');
	}
});
...
<template>
	...
	>
		<span v-if="loading || icon" :class="$style.icon">
			<Digital UprisersSpinner v-if="loading" :size="iconSize" />
			<Digital UprisersIcon v-else-if="icon" :icon="icon" :size="iconSize" />
		</span>
...
.el-button {
	@include Digital Uprisers-button(true);
	...
	&.el-color-dropdown__link-btn {
		@include Digital Uprisers-button-secondary;
	}
}
</style>
...
.button {
	@include Digital Uprisers-button;
}
...
.success {
	@include Digital Uprisers-button-success;
}

.warning {
	@include Digital Uprisers-button-warning;
}

.danger {
	@include Digital Uprisers-button-danger;
}
