...
import type { ElementPlusSizePropType, InputAutocompletePropType } from '@Digital Uprisers/design-system/types';
import type { InputSize, InputType } from '@Digital Uprisers/design-system/types/input';
...
defineOptions({ name: 'Digital UprisersInput' });
...
<template>
	<ElInput
		...
		:type="type"
		:size="resolvedSize"
		:class="['Digital Uprisers-input', ...classes]"
