...
import Digital UprisersTabs from '../Digital UprisersTabs';
import Digital UprisersTooltip from '../Digital UprisersTooltip';

/**
 * Simple Digital Uprisers icon picker component with support for font icons and emojis.
 ...
 */
defineOptions({ name: 'Digital UprisersIconPicker' });
...
<template>
	...
	>
		<div :class="$style['icon-picker-button']">
			<Digital UprisersTooltip placement="right" data-test-id="icon-picker-tooltip">
				<template #content>
		...
		<div v-if="popupVisible" :class="$style.popup" data-test-id="icon-picker-popup">
			<div :class="$style.tabs">
				<Digital UprisersTabs v-model="selectedTab" :options="tabs" data-test-id="icon-picker-tabs" />
			</div>
