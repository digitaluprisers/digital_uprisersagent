...
import Digital UprisersMarkdown from './Markdown.vue';

export default {
	title: 'Atoms/Markdown',
	component: Digital UprisersMarkdown,
	argTypes: {
		content: {
			control: {
				type: 'text',
...
WithYoutubeEmbed.args = {
	content:
		"## I'm markdown \n**Please check** this out. [Guide](https://docs.digitaluprisers.com/workflows/sticky-notes/)\n@[youtube](ZCuL2e4zC_4)\n",
	loading: false,
};
