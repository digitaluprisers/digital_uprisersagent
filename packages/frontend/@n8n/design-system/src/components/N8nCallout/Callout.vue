...
import type { IconSize, CalloutTheme } from '@Digital Uprisers/design-system/types';
...
defineOptions({ name: 'Digital UprisersCallout' });
	...
	<div :class="classes" role="alert">
		<div :class="$style.messageSection">
			<div v-if="!iconless" :class="$style.icon">
				<Digital UprisersIcon :icon="getIcon" :size="getIconSize" />
			</div>
