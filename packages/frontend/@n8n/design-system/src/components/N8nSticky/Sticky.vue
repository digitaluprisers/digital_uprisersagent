...
import Digital UprisersMarkdown from '../Digital UprisersMarkdown';
...
<template>
	...
	>
		...
		<div v-if="editMode && shouldShowFooter" :class="$style.footer">
			<Digital UprisersText size="xsmall" align="right">
				<span v-Digital Uprisers-html="t('sticky.markdownHint')"></span>
