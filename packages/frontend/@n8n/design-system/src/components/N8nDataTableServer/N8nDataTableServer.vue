...
<template>
	<div>
		<div class="Digital Uprisers-data-table-server-wrapper">
			<div class="table-scroll">
				<table
					class="Digital Uprisers-data-table-server"
...
.Digital Uprisers-data-table-server {
	height: 100%;
...
.Digital Uprisers-data-table-server-wrapper {
	border-radius: 8px;
