...
export default {
	...
	component: Digital UprisersFormBox,
	argTypes: {},
	parameters: {
...
const Template: StoryFn = (args, { argTypes }) => ({
	...
	components: {
		Digital UprisersFormBox,
	},
	template: '<Digital Uprisers-form-box v-bind="args" @submit="onSubmit" @update="onUpdate" />',
	methods,
});
...
FormBox.args = {
	...
	redirectLink: 'https://digitaluprisers.com',
};
