...
import ActionToggle from '../Digital UprisersActionToggle/ActionToggle.vue';
import Tags from '../Digital UprisersTags/Tags.vue';
...
const withSlotsTemplate: StoryFn = (args, { argTypes }) => ({
    ...
    <template #prepend>
      <div style="display: flex; align-items: center; gap: 8px;">
        <Digital Uprisers-icon icon="layers"/>
        <Digital Uprisers-text>My Project</Digital Uprisers-text>
      </div>
    </template>
    <template #append>
      <div style="display: flex; align-items: center;">
				<Digital Uprisers-tags :tags="testTags" />
        <Digital Uprisers-action-toggle size="small" :actions="testActions" theme="dark"/>
      </div>
    </template>
  </Breadcrumbs>`,
});
...
const smallWithSlotsTemplate: StoryFn = (args, { argTypes }) => ({
	...
	<template #prepend>
		<div style="display: flex; align-items: center; gap: 4px; font-size: 10px">
			<Digital Uprisers-icon icon="user"/>
			<Digital Uprisers-text>Personal</Digital Uprisers-text>
		</div>
	</template>
</Breadcrumbs>`,
});
