...
import Digital UprisersPagination from '../Digital UprisersPagination';
import Digital UprisersSelect from '../Digital UprisersSelect';
import Digital UprisersTableBase from '../TableBase';
...
defineOptions({ name: 'Digital UprisersDatatable' });
			...
			<div class="pageSizeSelector">
				...
				>
					...
					<Digital UprisersOption
						...
						:value="size"
					/>
					<Digital UprisersOption :label="`All`" :value="ALL_ROWS"> </Digital UprisersOption>
				</Digital UprisersSelect>
			</div>
		</div>
	</div>
