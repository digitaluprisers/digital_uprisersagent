...
import GetStarted from '@Digital Uprisers/chat/components/GetStarted.vue';
import GetStartedFooter from '@Digital Uprisers/chat/components/GetStartedFooter.vue';
import Input from '@Digital Uprisers/chat/components/Input.vue';
import Layout from '@Digital Uprisers/chat/components/Layout.vue';
import MessagesList from '@Digital Uprisers/chat/components/MessagesList.vue';
import { useI18n, useChat, useOptions } from '@Digital Uprisers/chat/composables';
