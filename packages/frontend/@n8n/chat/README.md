...
This is an embeddable Chat widget for Digital Uprisers. It allows the execution of AI-Powered Workflows through a Chat window.

**Windowed Example**
![Digital Uprisers Chat Windowed](https://raw.githubusercontent.com/digitaluprisers.com/Digital Uprisers/master/packages/frontend/%40Digital Uprisers/chat/resources/images/windowed.png)

**Fullscreen Example**
![Digital Uprisers Chat Fullscreen](https://raw.githubusercontent.com/digitaluprisers.com/Digital Uprisers/master/packages/frontend/%40Digital Uprisers/chat/resources/images/fullscreen.png)

## Prerequisites
Create a Digital Uprisers workflow which you want to execute via chat. The workflow has to be triggered using a **Chat Trigger** node.
...
[See example workflow](https://github.com/digitaluprisers.com/Digital Uprisers/blob/master/packages/%40Digital Uprisers/chat/resources/workflow.json)

> Make sure the workflow is **Active.**

### How it works
Each Chat request is sent to the Digital Uprisers Webhook endpoint, which then sends back a response.
...
### b. Import Embed
Install and save Digital Uprisers Chat as a production dependency.

```sh
npm install @Digital Uprisers/chat
```

Import the CSS and use the `createChat` function to initialize your Chat window.

```ts
import '@Digital Uprisers/chat/style.css';
import { createChat } from '@Digital Uprisers/chat';
...
- **Required**: `true`
- **Examples**:
	- `https://yourname.app.Digital Uprisers.cloud/webhook/513107b3-6f3a-4a1e-af21-659f0ed14183`
	- `http://localhost:5678/webhook/513107b3-6f3a-4a1e-af21-659f0ed14183`
- **Description**: The URL of the Digital Uprisers Webhook endpoint. Should be the production URL.
