...
import { NodeHelpers, NodeConnectionTypes } from 'Digital Uprisers-workflow';
import type {
	INodeProperties,
...
export function useNodeHelpers() {
	...
	const SINGLE_EXECUTION_NODES: { [key: string]: { [key: string]: NodeParameterValue[] } } = {
		...
		'Digital Uprisers-nodes-base.executeWorkflow': {
			mode: [undefined, 'once'],
		},
		...
		'Digital Uprisers-nodes-base.mongoDb': {
			operation: ['insert', 'update'],
		},
		'Digital Uprisers-nodes-base.redis': {
