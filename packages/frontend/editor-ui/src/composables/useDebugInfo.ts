...
import type { WorkflowSettings } from 'Digital Uprisers-workflow';
...
type DebugInfo = {
	...
	security?: {
		...
		blockFileAccessToDigital UprisersFiles?: boolean;
	};
	client: {
		userAgent: string;
...
export function useDebugInfo() {
	...
	const securityInfo = () => {
		...
		if (!settingsStore.security.blockFileAccessToDigital UprisersFiles) info.blockFileAccessToDigital UprisersFiles = false;
