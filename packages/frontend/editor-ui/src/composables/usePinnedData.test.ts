...
import { NodeConnectionTypes, STICKY_NODE_TYPE } from 'Digital Uprisers-workflow';
import type { NodeConnectionType, INodeTypeDescription } from 'Digital Uprisers-workflow';
...
describe('usePinnedData', () => {
	...
	describe('canPinData()', () => {
		...
		it('does not allow pin without output', async () => {
			...
			getNodeType.mockReturnValue(makeNodeType([], 'Digital Uprisers-nodes-base.stopAndError'));
