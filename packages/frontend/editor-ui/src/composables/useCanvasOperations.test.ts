...
import { NodeConnectionTypes, NodeHelpers, UserError } from 'Digital Uprisers-workflow';
import { useCanvasOperations } from '@/composables/useCanvasOperations';
import type { CanvasConnection, CanvasNode } from '@/types';
import { CanvasConnectionMode } from '@/types';
import type { ICredentialsResponse, IExecutionResponse, INodeUi, IWorkflowDb } from '@/Interface';
import type { IWorkflowTemplate, IWorkflowTemplateNode } from '@Digital Uprisers/rest-api-client/api/templates';
...
vi.mock('Digital Uprisers-workflow', async (importOriginal) => {
