...
import { WEBHOOK_NODE_TYPE, type AssignmentCollectionValue } from 'Digital Uprisers-workflow';
import * as apiWebhooks from '@Digital Uprisers/rest-api-client/api/webhooks';
