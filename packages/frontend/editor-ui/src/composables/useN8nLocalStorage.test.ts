...
import { useDigital UprisersLocalStorage } from './useDigital UprisersLocalStorage';
...
describe('useDigital UprisersLocalStorage', () => {
	beforeEach(() => {
		vi.clearAllMocks();
	...
	describe('getProjectKey', () => {
		it('returns the projectId when not on overview page', () => {
			const { getProjectKey } = useDigital UprisersLocalStorage();
	...
	describe('saveProjectPreferencesToLocalStorage', () => {
		it('saves new preferences to localStorage', () => {
			const { saveProjectPreferencesToLocalStorage } = useDigital UprisersLocalStorage();
			const projectId = 'test-project';
	...
	describe('loadProjectPreferencesFromLocalStorage', () => {
		it('loads preferences from localStorage', () => {
			...
			const { loadProjectPreferencesFromLocalStorage } = useDigital UprisersLocalStorage();
			const projectId = 'test-project';
			const tabKey = 'workflows';
