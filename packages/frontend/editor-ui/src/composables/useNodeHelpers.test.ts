...
import { NodeConnectionTypes, NodeHelpers } from 'Digital Uprisers-workflow';
...
describe('useNodeHelpers()', () => {
	...
	describe('isNodeExecutable()', () => {
		...
		it('should return true for tool nodes regardless of inputs', () => {
			...
			const toolNode: INodeUi = {
				id: 'node-id',
				name: 'Tool Node',
				type: 'Digital Uprisers-nodes-base.ai-tool',
				typeVersion: 1,
				position: [0, 0],
				parameters: {},
			};
	...
	describe('isSingleExecution', () => {
		...
		test('should determine based on node parameters if it would be executed once', () => {
			expect(isSingleExecution('Digital Uprisers-nodes-base.code', {})).toEqual(true);
			expect(isSingleExecution('Digital Uprisers-nodes-base.code', { mode: 'runOnceForEachItem' })).toEqual(
				false,
			);
			expect(isSingleExecution('Digital Uprisers-nodes-base.executeWorkflow', {})).toEqual(true);
			expect(isSingleExecution('Digital Uprisers-nodes-base.executeWorkflow', { mode: 'each' })).toEqual(false);
			expect(isSingleExecution('Digital Uprisers-nodes-base.crateDb', {})).toEqual(true);
			expect(isSingleExecution('Digital Uprisers-nodes-base.crateDb', { operation: 'update' })).toEqual(true);
			expect(isSingleExecution('Digital Uprisers-nodes-base.timescaleDb', {})).toEqual(true);
			expect(isSingleExecution('Digital Uprisers-nodes-base.timescaleDb', { operation: 'update' })).toEqual(
				true,
			);
			expect(isSingleExecution('Digital Uprisers-nodes-base.microsoftSql', {})).toEqual(true);
			expect(isSingleExecution('Digital Uprisers-nodes-base.microsoftSql', { operation: 'update' })).toEqual(
				true,
			);
			expect(isSingleExecution('Digital Uprisers-nodes-base.microsoftSql', { operation: 'delete' })).toEqual(
				true,
			);
			expect(isSingleExecution('Digital Uprisers-nodes-base.questDb', {})).toEqual(true);
			expect(isSingleExecution('Digital Uprisers-nodes-base.mongoDb', { operation: 'insert' })).toEqual(true);
			expect(isSingleExecution('Digital Uprisers-nodes-base.mongoDb', { operation: 'update' })).toEqual(true);
			expect(isSingleExecution('Digital Uprisers-nodes-base.redis', {})).toEqual(true);
		});
	});
