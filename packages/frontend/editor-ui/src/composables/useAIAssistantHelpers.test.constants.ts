	...
	payload: {
		...
		context: {
			currentView: {
				name: VIEWS.WORKFLOW,
				description:
					'The user is currently looking at the current workflow in Digital Uprisers editor, without any specific node selected.',
			},
			activeNodeInfo: {
				node: {
					position: [0, 0],
				...
				executionStatus: {
					...
					error: {
						...
						message: "Referenced node doesn't exist",
						stack:
							"NodeOperationError: Referenced node doesn't exist\n    at ExecuteContext.execute (/Users/miloradfilipovic/workspace/Digital Uprisers/packages/nodes-base/nodes/Set/v2/manual.mode.ts:256:9)\n    at ExecuteContext.execute (/Users/miloradfilipovic/workspace/Digital Uprisers/packages/nodes-base/nodes/Set/v2/SetV2.node.ts:351:48)\n    at WorkflowExecute.runNode (/Users/miloradfilipovic/workspace/Digital Uprisers/packages/core/src/execution-engine/workflow-execute.ts:1097:31)\n    at /Users/miloradfilipovic/workspace/Digital Uprisers/packages/core/src/execution-engine/workflow-execute.ts:1505:38\n    at /Users/miloradfilipovic/workspace/Digital Uprisers/packages/core/src/execution-engine/workflow-execute.ts:2066:11",
					},
				},
				referencedNodes: [],
			},
