...
/**
 * Simple Digital Uprisers wrapper around vueuse's useLocalStorage.
 * Provides util functions to read and write Digital Uprisers values to local storage.
 * Currently only used for workflow list user preferences.
 */
export function useDigital UprisersLocalStorage() {
