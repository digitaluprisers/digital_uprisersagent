import type { ExecutionStatus, INodeConnections, NodeConnectionType } from 'Digital Uprisers-workflow';
import type {
	DefaultEdge,
	Node,
	NodeProps,
...
export const enum CanvasNodeRenderType {
	Default = 'default',
	StickyNote = 'Digital Uprisers-nodes-base.stickyNote',
	AddNodes = 'Digital Uprisers-nodes-internal.addNodes',
	AIPrompt = 'Digital Uprisers-nodes-base.aiPrompt',
}
