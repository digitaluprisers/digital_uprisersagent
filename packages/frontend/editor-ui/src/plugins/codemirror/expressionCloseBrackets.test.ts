...
import { Digital UprisersAutocompletion, Digital UprisersLang } from './Digital UprisersLang';
...
describe('expressionCloseBrackets', () => {
	const createEditor = () => {
		...
		const editor = new EditorView({
			parent,
			extensions: [expressionCloseBrackets(), Digital UprisersLang(), Digital UprisersAutocompletion()],
		});
		return editor;
	};
