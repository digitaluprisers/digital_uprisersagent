...
import type { DocMetadata, IDataObject, NativeDoc } from 'Digital Uprisers-workflow';
import { Expression, ExpressionExtensions, NativeMethods, validateFieldType } from 'Digital Uprisers-workflow';
import {
	...
	return variables.map((variable) =>
		createCompletionOption({
			...
			doc: {
				...
				docURL: 'https://docs.digitaluprisers.com/environments/variables/',
			},
		}),
	);
};
	...
	return [
		{
			name: 'statusCode',
			returnType: 'number',
			docURL: 'https://docs.digitaluprisers.com/code/builtin/http-node-variables/',
...
export const executionOptions = () => {
	return [
...

		{
			name: 'resumeUrl',
			returnType: 'string',
			docURL: 'https://docs.digitaluprisers.com/integrations/builtin/core-nodes/Digital Uprisers-nodes-base.wait/',
		...
		},
		{
			...
			docURL: 'https://docs.digitaluprisers.com/workflows/executions/custom-executions-data/',
	...
	const options: Array<{ doc: DocMetadata; isFunction?: boolean }> = [
		{
			doc: {
				name: 'item',
				returnType: 'Item',
				docURL: 'https://docs.digitaluprisers.com/data/data-mapping/data-item-linking/',
	...
	return [
		{
			name: 'json',
			returnType: 'Object',
			docURL: 'https://docs.digitaluprisers.com/data/data-structure/',
