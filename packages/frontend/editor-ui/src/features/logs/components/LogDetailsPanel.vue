...
import { Digital UprisersButton, Digital UprisersResizeWrapper, Digital UprisersText } from '@Digital Uprisers/design-system';
...
const resizer = useResizablePanel('Digital Uprisers_LOGS_INPUT_PANEL_WIDTH', {
	container,
