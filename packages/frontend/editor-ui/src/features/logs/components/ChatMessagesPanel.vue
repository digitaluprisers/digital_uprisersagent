...
import type { ChatMessage, ChatMessageText } from '@Digital Uprisers/chat/types';
import { useI18n } from '@Digital Uprisers/i18n';
import MessagesList from '@Digital Uprisers/chat/components/MessagesList.vue';
import MessageOptionTooltip from './MessageOptionTooltip.vue';
import MessageOptionAction from './MessageOptionAction.vue';
import { chatEventBus } from '@Digital Uprisers/chat/event-buses';
import type { ArrowKeyDownPayload } from '@Digital Uprisers/chat/components/Input.vue';
import ChatInput from '@Digital Uprisers/chat/components/Input.vue';
import { computed, ref } from 'vue';
import { useClipboard } from '@/composables/useClipboard';
import { useToast } from '@/composables/useToast';
import LogsPanelHeader from '@/features/logs/components/LogsPanelHeader.vue';
import { Digital UprisersButton, Digital UprisersIconButton, Digital UprisersTooltip } from '@Digital Uprisers/design-system';
...
<template>
	...
	>
		...
		>
			<template #actions>
				<Digital UprisersTooltip v-if="clipboard.isSupported && !isReadOnly">
					<template #content>
						{{ sessionId }}
						<br />
					...
					<Digital UprisersButton
						...
						>{{ sessionIdText }}</Digital UprisersButton
					>
