...
import { Digital UprisersButton, Digital UprisersRadioButtons, Digital UprisersText, Digital UprisersTooltip } from '@Digital Uprisers/design-system';
			...
			<template #actions>
				...
				>
					<Digital UprisersButton
						...
						>{{ locale.baseText('logs.overview.header.actions.clearExecution') }}</Digital UprisersButton
					>
				</Digital UprisersTooltip>
				<slot name="actions" />
			</template>
