...
import { Digital UprisersInputLabel } from '@Digital Uprisers/design-system';
import {
...
watch(
	() => props.isReadOnly,
	(isReadOnly) => {
		// Patch fix, see https://linear.app/Digital Uprisers/issue/ADO-2974/resource-mapper-values-are-emptied-when-refreshing-the-columns
