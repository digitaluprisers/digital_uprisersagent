...
import { FORM_TRIGGER_NODE_TYPE } from 'Digital Uprisers-workflow';
...
<template>
	...
	>
		<template #content>
			<Digital Uprisers-callout theme="danger" data-test-id="conflicting-webhook-callout">
			...
			<div :class="$style.container">
				<div>
					<Digital Uprisers-text color="text-base"> You can deactivate </Digital Uprisers-text>
					<Digital Uprisers-link :to="workflowUrl" :underline="true"> '{{ data.workflowName }}' </Digital Uprisers-link>
			...
			<div data-test-id="conflicting-webhook-path">
				<Digital Uprisers-text color="text-light"> {{ webhookUrl }}/</Digital Uprisers-text>
				<Digital Uprisers-text color="text-dark" bold>
					{{ data.webhookPath }}
				</Digital Uprisers-text>
			</div>
		</template>
