...
<template>
	...
	>
		...
		>
			<Digital Uprisers-badge v-if="customDataLength > 0" :class="$style.badge" theme="primary">
				{{ customDataLength.toString() }}
			</Digital Uprisers-badge>
		</Digital UprisersButton>
		<template #dropdown>
			<div
				ref="container"
			...
			>
				<div :class="$style.section">
					<div :class="$style.heading">
						<Digital Uprisers-heading tag="h3" size="small" color="text-dark">
					...
					>
						...
						>
							<Digital Uprisers-text :class="$style.key" size="small" color="text-base">
								{{ attr }}
							</Digital Uprisers-text>
							<Digital Uprisers-text :class="$style.value" size="small" color="text-base">
					...
					>
						<Digital Uprisers-text color="text-base" size="small" align="center">
							<span v-Digital Uprisers-html="i18n.baseText('executionAnnotationView.data.notFound')" />
						</Digital Uprisers-text>
					</div>
				</div>
			</div>
