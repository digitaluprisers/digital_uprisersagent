...
<template>
	...
	>
		<div :class="$style.heading">
			<Digital Uprisers-heading tag="h2" size="medium" color="text-dark">
		...
		>
			<div v-if="loading" class="mr-l">
				<Digital Uprisers-loading variant="rect" />
			</div>
			<div
			...
			>
				<Digital Uprisers-text color="text-base" size="medium" align="center">
			...
			<div v-if="loadingMore" class="mr-m">
				<Digital Uprisers-loading variant="p" :rows="1" />
			</div>
		</div>
