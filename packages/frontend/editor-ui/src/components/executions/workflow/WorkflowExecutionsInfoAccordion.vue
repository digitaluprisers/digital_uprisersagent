...
import type { IWorkflowSettings } from 'Digital Uprisers-workflow';
...
import { type IAccordionItem } from '@Digital Uprisers/design-system/components/Digital UprisersInfoAccordion/InfoAccordion.vue';
	...
	>
		<template #customContent>
			<footer class="mt-2xs">
				...
				<Digital UprisersTooltip :disabled="!isNewWorkflow">
					<template #content>
						<div>
							<Digital UprisersLink @click.prevent="onSaveWorkflowClick">{{
