...
import type { AnnotationVote, ExecutionSummary } from 'Digital Uprisers-workflow';
...
<template>
	<div v-if="executionUIDetails?.name === 'new'" :class="$style.newInfo">
		<Digital UprisersText :class="$style.newMessage" color="text-light">
			{{ locale.baseText('executionDetails.newMessage') }}
		</Digital UprisersText>
		<Digital UprisersButton class="mt-l" type="tertiary" @click="handleStopClick">
	...
	<div v-else-if="executionUIDetails?.name === 'running'" :class="$style.runningInfo">
		...
		<Digital UprisersText :class="$style.runningMessage" color="text-light">
		...
		>
			<div :class="$style.executionDetailsLeft">
				<div :class="$style.executionTitle">
					<Digital UprisersText size="large" color="text-dark" :bold="true" data-test-id="execution-time">{{
				...
				<div v-if="execution.mode === 'retry'" :class="$style.executionDetailsRetry">
					<Digital UprisersText color="text-base" size="small">
