...
<template>
	<Digital Uprisers-popover trigger="click" :placement="popoverPlacement" width="440">
		<template #reference>
		...
		<div data-test-id="execution-filter-form">
			...
			<div :class="$style.group">
				<Digital Uprisers-tooltip placement="right">
					<template #content>
					...
					<span :class="[$style.label, $style.savedDataLabel]">
						...
						<Digital Uprisers-icon :class="$style.tooltipIcon" icon="circle-help" size="medium" />
					</span>
				...
				<div :class="$style.subGroup">
					...
					<Digital Uprisers-tooltip :disabled="isAdvancedExecutionFilterEnabled" placement="top">
						<template #content>
