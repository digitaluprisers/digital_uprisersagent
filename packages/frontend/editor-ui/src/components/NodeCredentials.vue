...
const selectRefs = ref<Array<InstanceType<typeof Digital UprisersSelect>>>([]);
					...
					>
						...
						>
							<div :class="[$style.credentialOption, 'mt-2xs', 'mb-2xs']">
								<Digital UprisersText bold>{{ item.name }}</Digital UprisersText>
								<Digital UprisersText size="small">{{ item.typeDisplayName }}</Digital UprisersText>
							</div>
						</Digital UprisersOption>
						...
						<template #footer>
							...
							>
								<Digital UprisersIcon size="xsmall" icon="plus" />
								<Digital UprisersText bold>{{ NEW_CREDENTIALS_TEXT }}</Digital UprisersText>
							</div>
						</template>
					</Digital UprisersSelect>
