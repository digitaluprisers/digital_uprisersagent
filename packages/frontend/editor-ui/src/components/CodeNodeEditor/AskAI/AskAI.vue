...
import { Digital UprisersButton, Digital UprisersInput, Digital UprisersTooltip } from '@Digital Uprisers/design-system/components';
import { randomInt } from 'Digital Uprisers-workflow';
import type { CodeExecutionMode, INodeExecutionData } from 'Digital Uprisers-workflow';
	...
	<div>
		...
		<div :class="$style.inputContainer">
			<div :class="$style.meta">
				...
				/>
				<a href="https://docs.digitaluprisers.com/code-examples/ai-code" target="_blank" :class="$style.help">
					<Digital Uprisers-icon icon="circle-help" color="text-light" size="large" />{{
		...
		<div :class="$style.controls">
			<div v-if="isLoading" :class="$style.loader">
				...
				<Digital Uprisers-circle-loader :radius="8" :progress="loaderProgress" :stroke-width="3" />
			</div>
			<Digital UprisersTooltip v-else :disabled="isSubmitEnabled">
				<div>
