...
import { isIconOrEmoji } from '@Digital Uprisers/design-system/components/Digital UprisersIconPicker/types';
...
<template>
	<div :class="$style.projectInfo" data-test-id="project-sharing-info">
		<div>
			...
			<Digital UprisersAvatar v-else :first-name="processedName.firstName" :last-name="processedName.lastName" />
