...
import { type IconOrEmoji } from '@Digital Uprisers/design-system/components/Digital UprisersIconPicker/types';
...
<template>
	...
	>
		<Digital UprisersIcon
			...
			:color="color"
		></Digital UprisersIcon>
		<Digital UprisersText v-else-if="icon.type === 'emoji'" color="text-light" :class="$style.emoji">
			{{ icon.value }}
