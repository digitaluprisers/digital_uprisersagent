...
import type { INodeParameters, INodeProperties } from 'Digital Uprisers-workflow';
...
export const TEST_PARAMETERS: INodeProperties[] = [
	...
	{
		displayName:
			'Note: This is a notice with <a href="notice.digitaluprisers.com" target="_blank">notice link</a>',
		name: 'testNotice',
		type: 'notice',
		default: '',
		displayOptions: {
	...
	{
		displayName:
			'Tip: This is a callout with <a href="callout.digitaluprisers.com" target="_blank">callout link</a>',
		name: 'testCallout',
		type: 'callout',
		default: '',
		displayOptions: {
