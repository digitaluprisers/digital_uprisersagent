		...
		const status: SourceControlledFile[] = [
			{
				...
				location: 'local',
				conflict: false,
				file: '/home/user/.Digital Uprisers/git/workflows/gTbbBkkYTnNyX1jD.json',
			...
			},
			{
				...
				location: 'local',
				conflict: false,
				file: '/home/user/.Digital Uprisers/git/workflows/JIGKevgZagmJAnM6.json',
	...
	it('should push all entities besides workflows and credentials', async () => {
		const status: SourceControlledFile[] = [
			...
			},
			{
				...
				location: 'local',
				conflict: false,
				file: '/Users/raul/.Digital Uprisers/git/tags.json',
			...
			},
			{
				...
				location: 'local',
				conflict: false,
				file: '/Users/raul/.Digital Uprisers/git/folders.json',
				updatedAt: '2024-12-04T11:29:22.095Z',
			},
		];
