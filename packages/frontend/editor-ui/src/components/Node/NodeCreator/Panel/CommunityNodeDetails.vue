	...
	<div v-if="communityNodeDetails" :class="$style.container">
		<div :class="$style.header">
			<div :class="$style.title">
				...
				<Digital UprisersTooltip v-if="communityNodeDetails.official" placement="bottom" :show-after="500">
					<template #content>
						{{
			...
			<div>
				<div v-if="communityNodeDetails.installed" :class="$style.installed">
					<Digital UprisersIcon v-if="!communityNodeDetails.official" :class="$style.installedIcon" icon="box" />
					<Digital UprisersText color="text-light" size="small" bold>
