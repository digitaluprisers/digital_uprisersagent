...
import type { INodeTypeDescription, NodeConnectionType, Themed } from 'Digital Uprisers-workflow';
import { EVALUATION_TRIGGER_NODE_TYPE, NodeConnectionTypes } from 'Digital Uprisers-workflow';
...
function getEvaluationNode(
	...
	const evaluationNodeStore = nodeTypesStore.getNodeType('Digital Uprisers-nodes-base.evaluation');
