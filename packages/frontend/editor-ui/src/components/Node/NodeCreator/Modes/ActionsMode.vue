		...
		<OrderSwitcher v-if="rootView" :root-view="rootView">
			<template v-if="shouldShowTriggers" #triggers>
				...
				>
					...
					<template v-else #empty>
						<p
							v-Digital Uprisers-html="i18n.baseText('nodeCreator.actionsCategory.noMatchingTriggers')"
			...
			<template v-if="!isTriggerRootView || parsedActionActionsBaseline.length !== 0" #actions>
				...
				>
					...
					>
						<span v-Digital Uprisers-html="i18n.baseText('nodeCreator.actionsCallout.triggersStartWorkflow')" />
					</Digital Uprisers-callout>
					<!-- Empty state -->
					<template #empty>
						<Digital Uprisers-info-tip v-if="!search" theme="info" type="note" :class="$style.actionsEmpty">
							<span
								v-Digital Uprisers-html="
						...
						<p
							v-else
							v-Digital Uprisers-html="i18n.baseText('nodeCreator.actionsCategory.noMatchingActions')"
							:class="$style.resetSearch"
