...
import AskAssistantChat from '@Digital Uprisers/design-system/components/AskAssistantChat/AskAssistantChat.vue';
	...
	<div data-test-id="ask-assistant-chat" tabindex="0" :class="$style.container" @keydown.stop>
		...
		>
			...
			<template #placeholder>
				<Digital Uprisers-text :class="$style.topText">{{
			...
			<template v-if="workflowGenerated" #inputPlaceholder>
				<div :class="$style.newWorkflowButtonWrapper">
					...
					<Digital Uprisers-text :class="$style.newWorkflowText">
