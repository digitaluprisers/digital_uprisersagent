...
import AssistantIcon from '@Digital Uprisers/design-system/components/AskAssistantIcon/AssistantIcon.vue';
import AssistantText from '@Digital Uprisers/design-system/components/AskAssistantText/AssistantText.vue';
	...
	>
		...
		<template #content>
			<div :class="$style.container">
				<p>
					<Digital Uprisers-text>{{ i18n.baseText('aiAssistant.newSessionModal.message') }}</Digital Uprisers-text>
				</p>
				<p>
					<Digital Uprisers-text>{{ i18n.baseText('aiAssistant.newSessionModal.question') }}</Digital Uprisers-text>
				</p>
			</div>
		</template>
		<template #footer>
			<div :class="$style.footer">
				<Digital Uprisers-button :label="i18n.baseText('generic.cancel')" type="secondary" @click="close" />
