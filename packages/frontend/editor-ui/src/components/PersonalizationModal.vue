		...
		[
			{
				...
				properties: {
					...
					options: [
						...
						{
							label: i18n.baseText('personalizationModal.imNotUsingDigital UprisersForWork'),
			...
			},
			{
				...
				properties: {
					type: 'select',
					label: i18n.baseText('personalizationModal.howDidYouHearAboutDigital Uprisers'),
					placeholder: i18n.baseText('personalizationModal.select'),
					options: [
						{
							label: 'Google',
...
const onSubmit = async (values: object) => {
	...
	try {
		const completedSurvey: IPersonalizationLatestVersion = {
			...
			personalization_survey_Digital Uprisers_version: rootStore.versionCli,
		};
...
<template>
	<Modal
		...
		:title="i18n.baseText('personalizationModal.customizeDigital Uprisers')"
