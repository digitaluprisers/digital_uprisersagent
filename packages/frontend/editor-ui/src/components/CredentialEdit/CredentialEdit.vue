...
import { Digital UprisersInlineTextEdit, Digital UprisersText, type IMenuItem } from '@Digital Uprisers/design-system';
			...
			<div :class="$style.header">
				<div :class="$style.credInfo">
					...
					<div ref="credNameRef" :class="$style.credName">
						...
						/>
						<Digital UprisersText v-if="credentialType" size="small" tag="p" color="text-light">{{
