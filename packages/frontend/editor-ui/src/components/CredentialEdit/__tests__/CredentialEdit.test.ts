...
const oAuth2Api: ICredentialType = {
	...
	iconUrl: 'icons/Digital Uprisers-nodes-base/dist/nodes/GraphQL/graphql.png',
	supportedNodes: ['Digital Uprisers-nodes-base.graphql', 'Digital Uprisers-nodes-base.httpRequest'],
};
...
const googleOAuth2Api: ICredentialType = {
	...
	iconUrl: 'icons/Digital Uprisers-nodes-base/dist/credentials/icons/Google.svg',
	supportedNodes: [],
};
...
const googleBigQueryOAuth2Api: ICredentialType = {
	...
	iconUrl: 'icons/Digital Uprisers-nodes-base/dist/nodes/Google/BigQuery/googleBigQuery.svg',
	supportedNodes: ['Digital Uprisers-nodes-base.googleBigQuery'],
};

vi.mock('@Digital Uprisers/permissions', () => ({
	...
	test.each([
		{
			...
			data: {
				clientId: 'client_id',
				clientSecret: '__Digital Uprisers_EMPTY_VALUE_7b1af746-3729-4c60-9b9b-e08eb29e58da',
			},
		},
		{
