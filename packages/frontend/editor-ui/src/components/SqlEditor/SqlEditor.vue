...
} from '@Digital Uprisers/codemirror-lang-sql';
...
const extensions = computed(() => {
	...
	function sqlWithDigital UprisersLanguageSupport() {
		return new LanguageSupport(dialect.language, [
			...
			Digital UprisersCompletionSources().map((source) => dialect.language.data.of(source)),
		]);
	}

	const baseExtensions = [
		sqlWithDigital UprisersLanguageSupport(),
		expressionCloseBrackets(),
		codeEditorTheme({
