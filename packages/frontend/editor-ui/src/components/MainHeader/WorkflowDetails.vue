...
import type { WorkflowDataUpdate } from '@Digital Uprisers/rest-api-client/api/workflows';
...
import { Digital UprisersInlineTextEdit } from '@Digital Uprisers/design-system';
			...
			<EnterpriseEdition :features="[EnterpriseEditionFeature.Sharing]">
				...
				<template #fallback>
					<Digital UprisersTooltip>
						<Digital UprisersButton type="secondary" :class="['mr-2xs', $style.disabledShareButton]">
							{{ i18n.baseText('workflowDetails.share') }}
						</Digital UprisersButton>
						<template #content>
							<i18n-t
