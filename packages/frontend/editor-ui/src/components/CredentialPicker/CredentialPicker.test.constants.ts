...
export const TEST_CREDENTIALS: ICredentialMap = {
	...
	1: {
		...
		homeProject: {
			id: '1',
			type: 'personal',
			name: 'Kobi Dog <kobi@digitaluprisers.com>',
			icon: null,
			createdAt: new Date().toISOString(),
			updatedAt: new Date().toISOString(),
		},
...
export const TEST_CREDENTIAL_TYPES: ICredentialTypeMap = {
	openAiApi: {
		...
		iconUrl: {
			light: 'icons/Digital Uprisers-nodes-base/dist/nodes/OpenAi/openai.svg',
			dark: 'icons/Digital Uprisers-nodes-base/dist/nodes/OpenAi/openai.dark.svg',
		},
		supportedNodes: [
			'Digital Uprisers-nodes-base.openAi',
			'@Digital Uprisers/Digital Uprisers-nodes-langchain.embeddingsOpenAi',
			'@Digital Uprisers/Digital Uprisers-nodes-langchain.lmChatOpenAi',
			'@Digital Uprisers/Digital Uprisers-nodes-langchain.lmOpenAi',
		],
	},
	supabaseApi: {
		name: 'supabaseApi',
		...
		iconUrl: 'icons/Digital Uprisers-nodes-base/dist/nodes/Supabase/supabase.svg',
		supportedNodes: ['Digital Uprisers-nodes-base.supabase'],
	},
	slackOAuth2Api: {
		name: 'slackOAuth2Api',
		extends: ['oAuth2Api'],
		...
		properties: [
			...
			{
				displayName:
					'If you get an Invalid Scopes error, make sure you add the correct one <a target="_blank" href="https://docs.digitaluprisers.com/integrations/builtin/credentials/slack/#using-oauth">here</a> to your Slack integration',
				name: 'notice',
				type: 'notice',
				default: '',
			},
		],
		iconUrl: 'icons/Digital Uprisers-nodes-base/dist/nodes/Slack/slack.svg',
		supportedNodes: ['Digital Uprisers-nodes-base.slack'],
	},
};
