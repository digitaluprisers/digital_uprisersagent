	...
	>
		<template #header>
			<div :class="$style.title">
				<Digital Uprisers-heading tag="h2" size="medium" color="text-xlight">{{ modalTitle }}</Digital Uprisers-heading>
			</div>
		</template>
		<template #content>
			<section :class="$style.content">
				<div v-if="showButtons" :class="$style.wrapper">
					...
					<div :class="$style.text">
						<Digital Uprisers-text size="small" color="text-xlight">{{ NOT_LIKELY_OPTION }}</Digital Uprisers-text>
						<Digital Uprisers-text size="small" color="text-xlight">{{ VERY_LIKELY_OPTION }}</Digital Uprisers-text>
					</div>
				</div>
				<div v-else :class="$style.email">
					...
					<div :class="$style.disclaimer">
						<Digital Uprisers-text size="small" color="text-dark">
