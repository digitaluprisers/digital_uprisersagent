...
import { Digital UprisersInlineTextEdit, Digital UprisersText } from '@Digital Uprisers/design-system';
			...
			<template v-else>
				<div :class="$style.header">
					<div ref="defNameRef" :class="$style.destinationInfo">
						...
						/>
						<Digital UprisersText size="small" tag="p" color="text-light">{{
			...
			<div :class="$style.container">
				...
				<template v-else>
					<div :class="$style.sidebar">
						<Digital Uprisers-menu mode="tabs" :items="sidebarItems" @select="onTabSelect"></Digital Uprisers-menu>
					</div>
