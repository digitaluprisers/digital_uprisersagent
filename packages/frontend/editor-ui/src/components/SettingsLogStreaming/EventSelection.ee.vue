		...
		>
			...
			>
				...
				<Digital Uprisers-tooltip
					...
					class="ml-xs"
				>
					<Digital Uprisers-icon icon="circle-help" size="small" class="ml-4xs" />
					<template #content>
			...
			<Checkbox
				v-if="group.name === 'Digital Uprisers.audit'"
			...
			>
				...
				<Digital Uprisers-tooltip placement="top" :popper-class="$style.tooltipPopper">
					<Digital Uprisers-icon icon="circle-help" size="small" class="ml-4xs" />
					<template #content>
