			...
			<Digital Uprisers-card :class="$style.card">
				...
				<template #header>
					<div :class="$style['card-header']">
						<Digital Uprisers-heading tag="h2" bold size="small" data-test-id="folder-card-name">
							{{ data.name }}
						</Digital Uprisers-heading>
						<Digital UprisersBadge v-if="readOnly" class="ml-3xs" theme="tertiary" bold>
...
.cardBadge.with-breadcrumbs {
	:global(.Digital Uprisers-badge) {
		padding-right: 0;
	}
	:global(.Digital Uprisers-breadcrumbs) {
...
@include mixins.breakpoint('sm-and-down') {
	.card {
		...
		:global(.Digital Uprisers-card-append) {
			width: 100%;
