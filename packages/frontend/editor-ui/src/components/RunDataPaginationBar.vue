	...
	<div :class="$style.pagination" data-test-id="ndv-data-pagination">
		...
		<div :class="$style.pageSizeSelector">
			...
			>
				...
				<Digital UprisersOption v-for="size in pageSizes" :key="size" :label="size" :value="size"> </Digital UprisersOption>
				<Digital UprisersOption :label="i18n.baseText('ndv.output.all')" :value="total"> </Digital UprisersOption>
			</Digital UprisersSelect>
		</div>
	</div>
</template>
