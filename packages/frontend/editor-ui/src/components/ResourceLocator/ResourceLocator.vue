...
import type { ResourceLocatorRequestDto, ActionResultRequestDto } from '@Digital Uprisers/api-types';
...
import { Digital UprisersNotice } from '@Digital Uprisers/design-system';
			...
			>
				...
				<div :class="$style.inputContainer" data-test-id="rlc-input-container">
					...
					<div v-else-if="urlValue" :class="$style.openResourceLink">
						<Digital Uprisers-link theme="text" @click.stop="openResource(urlValue)">
							<Digital Uprisers-icon icon="external-link" :title="getLinkAlt(valueToDisplay)" />
