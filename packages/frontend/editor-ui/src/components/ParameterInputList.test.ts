...
import { FORM_NODE_TYPE, FORM_TRIGGER_NODE_TYPE } from 'Digital Uprisers-workflow';
...
describe('ParameterInputList', () => {
	...
	it('renders notice correctly', () => {
		...
		expect(getByText('notice link').getAttribute('href')).toEqual('notice.digitaluprisers.com');
	});
	...
	it('renders callout correctly', () => {
		...
		expect(getByText('callout link').getAttribute('href')).toEqual('callout.digitaluprisers.com');
