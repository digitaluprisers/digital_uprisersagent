...
<template>
	<div :class="$style['api-key-scopes']">
		...
		<Digital UprisersInputLabel :label="i18n.baseText('settings.api.scopes.label')" color="text-dark">
			<ElSelect
		...
		<Digital UprisersNotice v-if="!enabled">
			<i18n-t keypath="settings.api.scopes.upgrade">
				<template #link>
					<Digital Uprisers-link size="small" @click="goToUpgradeApiKeyScopes">
