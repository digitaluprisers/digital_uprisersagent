...
describe('WhatsNewModal', () => {
	beforeEach(() => {
		...
		versionsStore.whatsNew = {
			...
			updatedAt: null,
			title: "What's New in Digital Uprisers 1.100.0",
			calloutText:
			...
			items: [
				{
					...
					content:
						...
						'Learn more about [sub-workflows](https://docs.digitaluprisers.com/flow-logic/subworkflows/).\n\n' +
	...
	it('should render with update button disabled', async () => {
		...
		expect(screen.getByText("What's New in Digital Uprisers 1.100.0")).toBeInTheDocument();
