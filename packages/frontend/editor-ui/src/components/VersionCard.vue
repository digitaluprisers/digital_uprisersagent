...
import type { Version, VersionNode } from '@Digital Uprisers/rest-api-client/api/versions';
	...
	>
		<div :class="$style.header">
			<div>
				...
				<WarningTooltip v-if="version.hasSecurityIssue">
					<span v-Digital Uprisers-html="i18n.baseText('versionCard.thisVersionHasASecurityIssue')"></span>
				</WarningTooltip>
				<Badge
		...
		<div>
			<div
				...
				v-Digital Uprisers-html="version.description"
