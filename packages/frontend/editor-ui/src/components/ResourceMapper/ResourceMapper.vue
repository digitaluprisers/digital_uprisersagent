...
import type { ResourceMapperFieldsRequestDto } from '@Digital Uprisers/api-types';
...
import { deepCopy, NodeHelpers } from 'Digital Uprisers-workflow';
...
import { Digital UprisersButton, Digital UprisersCallout, Digital UprisersNotice } from '@Digital Uprisers/design-system';
...
<template>
	<div class="mt-4xs" data-test-id="resource-mapper-container">
		...
		/>
		<Digital UprisersText v-if="!showMappingModeSelect && state.loading" size="small">
		...
		>
			<span v-Digital Uprisers-html="state.emptyFieldsNotice"></span>
		</Digital UprisersNotice>
		<Digital UprisersCallout v-else-if="state.hasStaleFields" theme="info" :iconless="true">
