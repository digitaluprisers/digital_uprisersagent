...
import { Digital UprisersNavigationDropdown, Digital UprisersTooltip, Digital UprisersLink, Digital UprisersIconButton } from '@Digital Uprisers/design-system';
import type { IMenuItem } from '@Digital Uprisers/design-system';
	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				link: {
					href: 'https://docs.digitaluprisers.com?utm_source=Digital Uprisers_app&utm_medium=app_sidebar',
					target: '_blank',
				},
			},
			{
				...
				link: {
					href: 'https://community.digitaluprisers.com?utm_source=Digital Uprisers_app&utm_medium=app_sidebar',
					target: '_blank',
				},
			},
			{
				...
				link: {
					href: 'https://docs.digitaluprisers.com/courses/',
					target: '_blank',
				},
			},
			{
			...
			},
			{
				id: 'about',
				icon: 'info',
				label: i18n.baseText('mainSidebar.aboutDigital Uprisers'),
				position: 'bottom',
			},
		],
	},
...
const createBtn = ref<InstanceType<typeof Digital UprisersNavigationDropdown>>();
...
<template>
	...
	>
		...
		>
			<Digital UprisersIcon v-if="isCollapsed" icon="chevron-right" size="xsmall" class="ml-5xs" />
			<Digital UprisersIcon v-else icon="chevron-left" size="xsmall" class="mr-5xs" />
		</div>
		<div :class="$style.logo">
						...
						<i18n-t keypath="readOnlyEnv.tooltip">
							<template #link>
								<Digital UprisersLink
									to="https://docs.digitaluprisers.com/source-control-environments/setup/#step-4-connect-Digital Uprisers-and-configure-your-instance"
									size="small"
								>
			...
			<Digital UprisersNavigationDropdown
				ref="createBtn"
				data-test-id="universal-add"
				:menu="menu"
				@select="handleMenuSelect"
			>
				<Digital UprisersIconButton icon="plus" type="secondary" outline />
				<template #[createWorkflowsAppendSlotName]>
					...
					>
						<Digital UprisersIcon style="margin-left: auto; margin-right: 5px" icon="lock" size="xsmall" />
					</Digital UprisersTooltip>
				</template>
		...
		<Digital UprisersMenu :items="mainMenuItems" :collapsed="isCollapsed" @select="handleSelect">
			<template #header>
				<ProjectNavigation
					:collapsed="isCollapsed"
			...
			<template v-if="showUserArea" #footer>
				<div ref="user" :class="$style.userArea">
					...
					>
						<Digital UprisersText size="small" :bold="true" color="text-dark">{{
