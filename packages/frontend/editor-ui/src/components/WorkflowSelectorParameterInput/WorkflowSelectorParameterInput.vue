...
import type { WorkflowDataCreate } from '@Digital Uprisers/rest-api-client/api/workflows';
		...
		>
			<template #error>
				<div :class="$style.error" data-test-id="rlc-error-container">
					<Digital Uprisers-text color="text-dark" align="center" tag="div">
			...
			>
				...
				<div :class="$style.inputContainer" data-test-id="rlc-input-container">
					...
					>
						<Digital Uprisers-link theme="text" @click.stop="openWorkflow()">
							<Digital Uprisers-icon icon="external-link" :title="'Open resource link'" />
