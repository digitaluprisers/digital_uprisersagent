...
<template>
	...
	>
		<template #content>
			<div>
				<Digital Uprisers-text>{{ triggerContent }}</Digital Uprisers-text>
			</div>
			<div :class="$style.spaced">
				<Digital Uprisers-text>
					<Digital Uprisers-text :bold="true">
		...
		<template #footer="{ close }">
			<div :class="$style.footer">
				...
				<Digital Uprisers-button :label="i18n.baseText('activationModal.gotIt')" @click="close" />
			</div>
		</template>
	</Modal>
</template>
