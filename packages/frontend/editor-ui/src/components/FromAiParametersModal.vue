...
import { useAgentRequestStore, type IAgentRequest } from '@Digital Uprisers/stores/useAgentRequestStore';
...
import type { FormFieldValueUpdate, IFormInput } from '@Digital Uprisers/design-system';
		...
		<template #content>
			<el-col>
				<el-row :class="$style.row">
					<Digital Uprisers-text data-testid="from-ai-parameters-modal-description">
						{{
