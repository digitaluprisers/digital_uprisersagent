...
import { Digital UprisersIcon, Digital UprisersRadioButtons } from '@Digital Uprisers/design-system';
...
<template>
	...
	>
		<template v-if="compact" #option="option">
			<Digital UprisersIcon v-if="option.value === 'table'" icon="table" size="small" />
			<Digital UprisersIcon v-else-if="option.value === 'json'" icon="json" size="small" />
			<Digital UprisersIcon v-else-if="option.value === 'binary'" icon="binary" size="small" />
			<Digital UprisersIcon v-else-if="option.value === 'schema'" icon="schema" size="small" />
			<Digital UprisersIcon v-else-if="option.value === 'html'" icon="file-code" size="small" />
			<Digital UprisersIcon v-else-if="option.value === 'ai'" icon="text" size="small" />
