...
import type { INodeTypeDescription, NodeConnectionType, NodeError } from 'Digital Uprisers-workflow';
			...
			<div :class="$style.headerWrap">
				...
				<ul :class="$style.meta">
					...
					<li v-if="(consumedTokensSum?.totalTokens ?? 0) > 0" :class="$style.tokensUsage">
						...
						<Digital Uprisers-info-tip type="tooltip" theme="info-light" tooltip-placement="right">
