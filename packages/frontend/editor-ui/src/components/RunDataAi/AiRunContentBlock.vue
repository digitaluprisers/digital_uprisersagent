...
import type { NodeConnectionType, NodeError } from 'Digital Uprisers-workflow';
import RunDataAi from '@/components/RunDataParsedAiContent.vue';
import { parseAiContent } from '@/utils/aiUtils';
import { Digital UprisersRadioButtons } from '@Digital Uprisers/design-system';
	...
	<div :class="$style.block">
		<header :class="$style.blockHeader" @click="onBlockHeaderClick">
			<button :class="$style.blockToggle">
				<Digital UprisersIcon :icon="isExpanded ? 'chevron-down' : 'chevron-right'" size="large" />
			</button>
