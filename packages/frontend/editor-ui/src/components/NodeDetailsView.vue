...
import type { IRunData, Workflow, NodeConnectionType, IConnectedNode } from 'Digital Uprisers-workflow';
import { jsonParse, NodeHelpers, NodeConnectionTypes } from 'Digital Uprisers-workflow';
import type {
	IRunDataDisplayMode,
	IUpdateInformation,
	NodePanelType,
...
import { useDeviceSupport } from '@Digital Uprisers/composables/useDeviceSupport';
	...
	>
		...
		>
			...
			<div :class="$style.backToCanvas" data-test-id="back-to-canvas" @click="close">
				<Digital Uprisers-icon icon="arrow-left" color="text-xlight" size="medium" />
				<Digital Uprisers-text color="text-xlight" size="medium" :bold="true">
		...
		>
			...
			>
				...
				<template #main>
					...
					>
						<Digital Uprisers-icon icon="lightbulb" />
