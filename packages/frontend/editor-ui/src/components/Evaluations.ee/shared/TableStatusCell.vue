...
import Digital UprisersTooltip from '@Digital Uprisers/design-system/components/Digital UprisersTooltip';
...
import type { BadgeTheme } from '@Digital Uprisers/design-system';
...
<template>
	...
	>
		<template #content>
			<div v-Digital Uprisers-html="getErrorTooltip(column, row)" />
		</template>
		<Digital UprisersBadge :theme="statusThemeMap[row.status]" class="mr-4xs">
