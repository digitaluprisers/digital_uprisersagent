...
import { getBecomeCreatorCta } from '@Digital Uprisers/rest-api-client/api/ctas';

const LOCAL_STORAGE_KEY = 'Digital Uprisers_BECOME_TEMPLATE_CREATOR_CTA_DISMISSED_AT';
