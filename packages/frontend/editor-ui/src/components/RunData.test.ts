...
import type { INodeExecutionData, ITaskData, ITaskMetadata } from 'Digital Uprisers-workflow';
			...
			runs: [
				{
					...
					error: {
						...
						message: 'yo [line 1]',
						stack: 'Error: yo\n Digital Uprisers/packages/core/src/execution-engine/workflow-execute.ts:2066:11',
					},
				},
			],
			defaultRunItems: [
