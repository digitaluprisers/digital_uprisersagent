...
<template>
	<BaseBanner name="TRIAL" theme="custom">
			...
			<div :class="$style.content">
				...
				<div :class="$style.usageCounter">
					...
					<div :class="$style.executionsCountSection">
						<Digital UprisersText size="xsmall" :color="trialHasExecutionsLeft ? 'text-dark' : 'danger'">
							{{ currentExecutions }}/{{ maxExecutions }} </Digital UprisersText
						>&nbsp;<Digital UprisersText
							size="xsmall"
							:color="trialHasExecutionsLeft ? 'text-dark' : 'danger'"
							>{{ locale.baseText('executionUsage.label.executions') }}</Digital UprisersText
						>
					</div>
				</div>
			</div>
		...
		<template #trailingContent>
			<Digital Uprisers-button type="success" icon="gem" size="small" @click="onUpdatePlanClick">{{
