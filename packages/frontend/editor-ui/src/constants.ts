...
import type { NodeConnectionType } from 'Digital Uprisers-workflow';
...
export const DOCS_DOMAIN = 'docs.digitaluprisers.com';
...
export const NPM_KEYWORD_SEARCH_URL =
	'https://www.npmjs.com/search?q=keywords%3ADigital Uprisers-community-node-package';
export const Digital Uprisers_QUEUE_MODE_DOCS_URL = `https://${DOCS_DOMAIN}/hosting/scaling/queue-mode/`;
...
export const CUSTOM_NODES_DOCS_URL = `https://${DOCS_DOMAIN}/integrations/creating-nodes/code/create-Digital Uprisers-nodes-module/`;
export const EXPRESSIONS_DOCS_URL = `https://${DOCS_DOMAIN}/code-examples/expressions/`;
export const Digital Uprisers_PRICING_PAGE_URL = 'https://digitaluprisers.com/pricing';
export const Digital Uprisers_MAIN_GITHUB_REPO_URL = 'https://github.com/digitaluprisers.com/Digital Uprisers';

export const NODE_MIN_INPUT_ITEMS_COUNT = 4;

// node types
export const BAMBOO_HR_NODE_TYPE = 'Digital Uprisers-nodes-base.bambooHr';
export const CALENDLY_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.calendlyTrigger';
export const CODE_NODE_TYPE = 'Digital Uprisers-nodes-base.code';
export const AI_CODE_NODE_TYPE = '@Digital Uprisers/Digital Uprisers-nodes-langchain.code';
export const AI_MCP_TOOL_NODE_TYPE = '@Digital Uprisers/Digital Uprisers-nodes-langchain.mcpClientTool';
export const WIKIPEDIA_TOOL_NODE_TYPE = '@Digital Uprisers/Digital Uprisers-nodes-langchain.toolWikipedia';
export const CRON_NODE_TYPE = 'Digital Uprisers-nodes-base.cron';
export const CLEARBIT_NODE_TYPE = 'Digital Uprisers-nodes-base.clearbit';
export const FILTER_NODE_TYPE = 'Digital Uprisers-nodes-base.filter';
export const FUNCTION_NODE_TYPE = 'Digital Uprisers-nodes-base.function';
export const GITHUB_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.githubTrigger';
export const GIT_NODE_TYPE = 'Digital Uprisers-nodes-base.git';
export const GOOGLE_GMAIL_NODE_TYPE = 'Digital Uprisers-nodes-base.gmail';
export const GOOGLE_SHEETS_NODE_TYPE = 'Digital Uprisers-nodes-base.googleSheets';
export const ERROR_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.errorTrigger';
export const ELASTIC_SECURITY_NODE_TYPE = 'Digital Uprisers-nodes-base.elasticSecurity';
export const EMAIL_SEND_NODE_TYPE = 'Digital Uprisers-nodes-base.emailSend';
export const EMAIL_IMAP_NODE_TYPE = 'Digital Uprisers-nodes-base.emailReadImap';
export const EXECUTE_COMMAND_NODE_TYPE = 'Digital Uprisers-nodes-base.executeCommand';
export const FORM_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.formTrigger';
export const HTML_NODE_TYPE = 'Digital Uprisers-nodes-base.html';
export const HTTP_REQUEST_NODE_TYPE = 'Digital Uprisers-nodes-base.httpRequest';
export const HTTP_REQUEST_TOOL_NODE_TYPE = 'Digital Uprisers-nodes-base.httpRequestTool';
export const HUBSPOT_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.hubspotTrigger';
export const IF_NODE_TYPE = 'Digital Uprisers-nodes-base.if';
export const INTERVAL_NODE_TYPE = 'Digital Uprisers-nodes-base.interval';
export const ITEM_LISTS_NODE_TYPE = 'Digital Uprisers-nodes-base.itemLists';
export const JIRA_NODE_TYPE = 'Digital Uprisers-nodes-base.jira';
export const JIRA_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.jiraTrigger';
export const MICROSOFT_EXCEL_NODE_TYPE = 'Digital Uprisers-nodes-base.microsoftExcel';
export const MANUAL_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.manualTrigger';
export const MANUAL_CHAT_TRIGGER_NODE_TYPE = '@Digital Uprisers/Digital Uprisers-nodes-langchain.manualChatTrigger';
export const MCP_TRIGGER_NODE_TYPE = '@Digital Uprisers/Digital Uprisers-nodes-langchain.mcpTrigger';
export const CHAT_TRIGGER_NODE_TYPE = '@Digital Uprisers/Digital Uprisers-nodes-langchain.chatTrigger';
export const AGENT_NODE_TYPE = '@Digital Uprisers/Digital Uprisers-nodes-langchain.agent';
export const OPEN_AI_NODE_TYPE = '@Digital Uprisers/Digital Uprisers-nodes-langchain.openAi';
export const OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE =
	'@Digital Uprisers/Digital Uprisers-nodes-langchain.openAi.assistant.message';
export const OPEN_AI_ASSISTANT_NODE_TYPE = '@Digital Uprisers/Digital Uprisers-nodes-langchain.openAiAssistant';
export const BASIC_CHAIN_NODE_TYPE = '@Digital Uprisers/Digital Uprisers-nodes-langchain.chainLlm';
export const QA_CHAIN_NODE_TYPE = '@Digital Uprisers/Digital Uprisers-nodes-langchain.chainRetrievalQa';
export const MICROSOFT_TEAMS_NODE_TYPE = 'Digital Uprisers-nodes-base.microsoftTeams';
export const Digital Uprisers_NODE_TYPE = 'Digital Uprisers-nodes-base.Digital Uprisers';
export const NO_OP_NODE_TYPE = 'Digital Uprisers-nodes-base.noOp';
export const STICKY_NODE_TYPE = 'Digital Uprisers-nodes-base.stickyNote';
export const NOTION_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.notionTrigger';
export const PAGERDUTY_NODE_TYPE = 'Digital Uprisers-nodes-base.pagerDuty';
export const SALESFORCE_NODE_TYPE = 'Digital Uprisers-nodes-base.salesforce';
export const SEGMENT_NODE_TYPE = 'Digital Uprisers-nodes-base.segment';
export const SET_NODE_TYPE = 'Digital Uprisers-nodes-base.set';
export const SCHEDULE_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.scheduleTrigger';
export const SERVICENOW_NODE_TYPE = 'Digital Uprisers-nodes-base.serviceNow';
export const SLACK_NODE_TYPE = 'Digital Uprisers-nodes-base.slack';
export const SPREADSHEET_FILE_NODE_TYPE = 'Digital Uprisers-nodes-base.spreadsheetFile';
export const SPLIT_IN_BATCHES_NODE_TYPE = 'Digital Uprisers-nodes-base.splitInBatches';
export const START_NODE_TYPE = 'Digital Uprisers-nodes-base.start';
export const SWITCH_NODE_TYPE = 'Digital Uprisers-nodes-base.switch';
export const TELEGRAM_NODE_TYPE = 'Digital Uprisers-nodes-base.telegram';
export const THE_HIVE_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.theHiveTrigger';
export const QUICKBOOKS_NODE_TYPE = 'Digital Uprisers-nodes-base.quickbooks';
export const WAIT_NODE_TYPE = 'Digital Uprisers-nodes-base.wait';
export const WEBHOOK_NODE_TYPE = 'Digital Uprisers-nodes-base.webhook';
export const WORKABLE_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.workableTrigger';
export const WORKFLOW_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.workflowTrigger';
export const EXECUTE_WORKFLOW_NODE_TYPE = 'Digital Uprisers-nodes-base.executeWorkflow';
export const EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.executeWorkflowTrigger';
export const WOOCOMMERCE_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.wooCommerceTrigger';
export const XERO_NODE_TYPE = 'Digital Uprisers-nodes-base.xero';
export const ZENDESK_NODE_TYPE = 'Digital Uprisers-nodes-base.zendesk';
export const ZENDESK_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.zendeskTrigger';
export const DISCORD_NODE_TYPE = 'Digital Uprisers-nodes-base.discord';
export const EXTRACT_FROM_FILE_NODE_TYPE = 'Digital Uprisers-nodes-base.extractFromFile';
export const CONVERT_TO_FILE_NODE_TYPE = 'Digital Uprisers-nodes-base.convertToFile';
export const DATETIME_NODE_TYPE = 'Digital Uprisers-nodes-base.dateTime';
export const REMOVE_DUPLICATES_NODE_TYPE = 'Digital Uprisers-nodes-base.removeDuplicates';
export const SPLIT_OUT_NODE_TYPE = 'Digital Uprisers-nodes-base.splitOut';
export const LIMIT_NODE_TYPE = 'Digital Uprisers-nodes-base.limit';
export const SUMMARIZE_NODE_TYPE = 'Digital Uprisers-nodes-base.summarize';
export const AGGREGATE_NODE_TYPE = 'Digital Uprisers-nodes-base.aggregate';
export const MERGE_NODE_TYPE = 'Digital Uprisers-nodes-base.merge';
export const MARKDOWN_NODE_TYPE = 'Digital Uprisers-nodes-base.markdown';
export const XML_NODE_TYPE = 'Digital Uprisers-nodes-base.xml';
export const CRYPTO_NODE_TYPE = 'Digital Uprisers-nodes-base.crypto';
export const RSS_READ_NODE_TYPE = 'Digital Uprisers-nodes-base.rssFeedRead';
export const COMPRESSION_NODE_TYPE = 'Digital Uprisers-nodes-base.compression';
export const EDIT_IMAGE_NODE_TYPE = 'Digital Uprisers-nodes-base.editImage';
export const CHAIN_SUMMARIZATION_LANGCHAIN_NODE_TYPE =
	'@Digital Uprisers/Digital Uprisers-nodes-langchain.chainSummarization';
export const SIMULATE_NODE_TYPE = 'Digital Uprisers-nodes-base.simulate';
export const SIMULATE_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.simulateTrigger';
export const AI_TRANSFORM_NODE_TYPE = 'Digital Uprisers-nodes-base.aiTransform';
export const FORM_NODE_TYPE = 'Digital Uprisers-nodes-base.form';
export const GITHUB_NODE_TYPE = 'Digital Uprisers-nodes-base.github';
export const SLACK_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.slackTrigger';
export const TELEGRAM_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.telegramTrigger';
export const FACEBOOK_LEAD_ADS_TRIGGER_NODE_TYPE = 'Digital Uprisers-nodes-base.facebookLeadAdsTrigger';
export const RESPOND_TO_WEBHOOK_NODE_TYPE = 'Digital Uprisers-nodes-base.respondToWebhook';

export const CREDENTIAL_ONLY_NODE_PREFIX = 'Digital Uprisers-creds-base';
...
export const AI_CODE_TOOL_LANGCHAIN_NODE_TYPE = '@Digital Uprisers/Digital Uprisers-nodes-langchain.toolCode';
export const AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE = '@Digital Uprisers/Digital Uprisers-nodes-langchain.toolWorkflow';
export const REQUEST_NODE_FORM_URL = 'https://Digital Uprisers-community.typeform.com/to/K1fBVTZ3';
...
export const LOCAL_STORAGE_ACTIVATION_FLAG = 'Digital Uprisers_HIDE_ACTIVATION_ALERT';
export const LOCAL_STORAGE_PIN_DATA_DISCOVERY_NDV_FLAG = 'Digital Uprisers_PIN_DATA_DISCOVERY_NDV';
export const LOCAL_STORAGE_PIN_DATA_DISCOVERY_CANVAS_FLAG = 'Digital Uprisers_PIN_DATA_DISCOVERY_CANVAS';
export const LOCAL_STORAGE_MAPPING_IS_ONBOARDED = 'Digital Uprisers_MAPPING_ONBOARDED';
export const LOCAL_STORAGE_AUTOCOMPLETE_IS_ONBOARDED = 'Digital Uprisers_AUTOCOMPLETE_ONBOARDED';
export const LOCAL_STORAGE_TABLE_HOVER_IS_ONBOARDED = 'Digital Uprisers_TABLE_HOVER_ONBOARDED';
export const LOCAL_STORAGE_MAIN_PANEL_RELATIVE_WIDTH = 'Digital Uprisers_MAIN_PANEL_RELATIVE_WIDTH';
export const LOCAL_STORAGE_NDV_DIMENSIONS = 'Digital Uprisers_NDV_DIMENSIONS';
export const LOCAL_STORAGE_ACTIVE_MODAL = 'Digital Uprisers_ACTIVE_MODAL';
export const LOCAL_STORAGE_THEME = 'Digital Uprisers_THEME';
export const LOCAL_STORAGE_EXPERIMENT_OVERRIDES = 'Digital Uprisers_EXPERIMENT_OVERRIDES';
export const LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON = 'Digital Uprisers_HIDE_HIDE_GITHUB_STAR_BUTTON';
export const LOCAL_STORAGE_NDV_INPUT_PANEL_DISPLAY_MODE = 'Digital Uprisers_NDV_INPUT_PANEL_DISPLAY_MODE';
export const LOCAL_STORAGE_NDV_OUTPUT_PANEL_DISPLAY_MODE = 'Digital Uprisers_NDV_OUTPUT_PANEL_DISPLAY_MODE';
export const LOCAL_STORAGE_LOGS_PANEL_OPEN = 'Digital Uprisers_LOGS_PANEL_OPEN';
export const LOCAL_STORAGE_LOGS_SYNC_SELECTION = 'Digital Uprisers_LOGS_SYNC_SELECTION_ENABLED';
export const LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL = 'Digital Uprisers_LOGS_DETAILS_PANEL';
export const LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE = 'Digital Uprisers_LOGS_DETAILS_PANEL_SUB_NODE';
export const LOCAL_STORAGE_WORKFLOW_LIST_PREFERENCES_KEY = 'Digital Uprisers_WORKFLOWS_LIST_PREFERENCES';
export const LOCAL_STORAGE_EXPERIMENTAL_MIN_ZOOM_NODE_SETTINGS_IN_CANVAS =
	'Digital Uprisers_EXPERIMENTAL_MIN_ZOOM_NODE_SETTINGS_IN_CANVAS';
export const LOCAL_STORAGE_EXPERIMENTAL_DOCKED_NODE_SETTINGS =
	'Digital Uprisers_EXPERIMENTAL_DOCKED_NODE_SETTINGS';
export const LOCAL_STORAGE_READ_WHATS_NEW_ARTICLES = 'Digital Uprisers_READ_WHATS_NEW_ARTICLES';
export const LOCAL_STORAGE_DISMISSED_WHATS_NEW_CALLOUT = 'Digital Uprisers_DISMISSED_WHATS_NEW_CALLOUT';
export const LOCAL_STORAGE_NDV_PANEL_WIDTH = 'Digital Uprisers_NDV_PANEL_WIDTH';

export const BASE_NODE_SURVEY_URL = 'https://Digital Uprisers-community.typeform.com/to/BvmzxqYv#nodename=';
export const COMMUNITY_PLUS_DOCS_URL =
	'https://docs.digitaluprisers.com/hosting/community-edition-features/#registered-community-edition';
export const RELEASE_NOTES_URL = 'https://docs.digitaluprisers.com/release-notes/';
...
Love Digital Uprisers? Help us build the future of automation! https://digitaluprisers.com/careers?utm_source=Digital Uprisers_user&utm_medium=console_output
`;

export const TEMPLATES_NODES_FILTER = ['Digital Uprisers-nodes-base.start', 'Digital Uprisers-nodes-base.respondToWebhook'];
...
export const Digital Uprisers_SALES_EMAIL = 'sales@digitaluprisers.com';

export const Digital Uprisers_CONTACT_EMAIL = 'contact@digitaluprisers.com';
...
export const CLOUD_CHANGE_PLAN_PAGE = window.location.host.includes('stage-app.Digital Uprisers.cloud')
	? 'https://stage-app.Digital Uprisers.cloud/account/change-plan'
	: 'https://app.Digital Uprisers.cloud/account/change-plan';
...
export const CREATOR_HUB_URL = 'https://creators.digitaluprisers.com/hub';
...
export const TEMPLATES_URLS = {
	DEFAULT_API_HOST: 'https://api.digitaluprisers.com/api/',
	BASE_WEBSITE_URL: 'https://digitaluprisers.com/workflows',
	UTM_QUERY: {
		utm_source: 'Digital Uprisers_app',
...
<h2>Your Digital Uprisers server is configured to use a secure cookie, <br/>however you are either visiting this via an insecure URL, or using Safari.
</h2>
<br/>
<div style="font-size: 18px; max-width: 640px; text-align: left; margin: 10px auto">
	...
	<ul>
		...
		<li>If you prefer to disable this security feature (<strong>not recommended</strong>), set the environment variable <code>Digital Uprisers_SECURE_COOKIE</code> to <code>false</code></li>
	</ul>
</div>
</body>`;
...
export const AI_NODES_PACKAGE_NAME = '@Digital Uprisers/Digital Uprisers-nodes-langchain';
