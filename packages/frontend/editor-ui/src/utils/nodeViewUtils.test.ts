...
import type { INode, INodeTypeDescription, INodeExecutionData, Workflow } from 'Digital Uprisers-workflow';
import type { INodeUi, XYPosition } from '@/Interface';
import { NodeHelpers, SEND_AND_WAIT_OPERATION } from 'Digital Uprisers-workflow';
...
describe('getGenericHints', () => {
	...
	it('should return a hint for expression in field name if found in Set node', () => {
		mockNode.type = 'Digital Uprisers-nodes-base.set';
	...
	it('should return Split In Batches setup hints if loop is not set up correctly', () => {
		mockNode.type = 'Digital Uprisers-nodes-base.splitInBatches';
