...
/**
 * Generates a workflow JSON object for an AI Agent in Digital Uprisers.
 */
export const getEasyAiWorkflowJson = (): WorkflowDataWithTemplateId => {
	return {
		name: 'Demo: My first AI Agent in Digital Uprisers',
		meta: {
...
export const getRagStarterWorkflowJson = (): WorkflowDataWithTemplateId => {
	return {
		name: 'Demo: RAG in Digital Uprisers',
		meta: {
		...
		nodes: [
			{
				...
				type: 'Digital Uprisers-nodes-base.formTrigger',
				typeVersion: 2.2,
				position: [-120, 0],
			...
			},
			{
				...
				type: '@Digital Uprisers/Digital Uprisers-nodes-langchain.embeddingsOpenAi',
				typeVersion: 1.2,
				position: [520, 480],
