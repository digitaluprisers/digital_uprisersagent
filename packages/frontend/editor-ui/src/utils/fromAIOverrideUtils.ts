...
const NODE_DENYLIST = [
	'@Digital Uprisers/Digital Uprisers-nodes-langchain.toolCode',
	'@Digital Uprisers/Digital Uprisers-nodes-langchain.toolHttpRequest',
	'@Digital Uprisers/Digital Uprisers-nodes-langchain.mcpClientTool',
	['@Digital Uprisers/Digital Uprisers-nodes-langchain.toolWorkflow', 1.2],
] as const;
