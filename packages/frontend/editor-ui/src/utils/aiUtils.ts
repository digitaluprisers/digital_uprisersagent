...
import type { IDataObject, INodeExecutionData, NodeConnectionType } from 'Digital Uprisers-workflow';
import { isObjectEmpty, NodeConnectionTypes } from 'Digital Uprisers-workflow';
