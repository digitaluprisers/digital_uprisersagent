...
import type { ITemplatesWorkflowFull, IWorkflowTemplate } from '@Digital Uprisers/rest-api-client/api/templates';
import type { WorkflowData } from '@Digital Uprisers/rest-api-client/api/workflows';
import { getNewWorkflow } from '@/api/workflows';
import { VIEWS } from '@/constants';
import type { useRootStore } from '@Digital Uprisers/stores/useRootStore';
...
import type { INodeCredentialsDetails } from 'Digital Uprisers-workflow';
