...
import type { IConnection, IConnections, INodeTypeDescription } from 'Digital Uprisers-workflow';
...
describe('mapLegacyConnectionsToCanvasConnections', () => {
		...
		const nodes: INodeUi[] = [
			{
				id: '1',
				name: 'Node A',
				type: 'Digital Uprisers-nodes-base.node',
				typeVersion: 1,
				position: [100, 100],
				parameters: {},
			},
	...
	// @issue https://linear.app/Digital Uprisers/issue/Digital Uprisers-7880/cannot-load-some-templates
