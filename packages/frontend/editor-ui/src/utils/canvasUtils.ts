...
/**
 * Maps multiple legacy Digital Uprisers connections to VueFlow connections
 */
...
/**
 * Maps a single legacy Digital Uprisers connection to a VueFlow connection
 */
...
/**
 * Maps a VueFlow connection to a legacy Digital Uprisers connection
 */
...
/**
 * Maps legacy Digital Uprisers node inputs to VueFlow connection handles
 */
