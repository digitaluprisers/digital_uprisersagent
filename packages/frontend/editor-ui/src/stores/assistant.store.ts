...
import type { ChatUI } from '@Digital Uprisers/design-system/types/assistant';
...
import type { ICredentialType, INodeParameters, NodeError, INode } from 'Digital Uprisers-workflow';
