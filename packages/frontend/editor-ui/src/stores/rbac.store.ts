...
import { hasScope as genericHasScope } from '@Digital Uprisers/permissions';
import type { ScopeOptions, Scope, Resource } from '@Digital Uprisers/permissions';
import { ref } from 'vue';
import { STORES } from '@Digital Uprisers/stores';
import type { Role } from '@Digital Uprisers/api-types';
