...
import * as eventsApi from '@Digital Uprisers/rest-api-client/api/events';
import * as settingsApi from '@Digital Uprisers/rest-api-client/api/settings';
import * as moduleSettingsApi from '@Digital Uprisers/rest-api-client/api/module-settings';
import { testHealthEndpoint } from '@Digital Uprisers/rest-api-client/api/templates';
import {
...
import type { IDataObject, WorkflowSettings } from 'Digital Uprisers-workflow';
...
export const useSettingsStore = defineStore(STORES.SETTINGS, () => {
	...
	const security = computed(() => ({
		blockFileAccessToDigital UprisersFiles: settings.value.security.blockFileAccessToDigital UprisersFiles,
	...
	const getSettings = async () => {
		...
		rootStore.setDigital UprisersMetadata(fetchedSettings.Digital UprisersMetadata || {});
