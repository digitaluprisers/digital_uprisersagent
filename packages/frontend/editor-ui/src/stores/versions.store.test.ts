...
import * as versionsApi from '@Digital Uprisers/rest-api-client/api/versions';
import type { IVersionNotificationSettings } from '@Digital Uprisers/api-types';
import type { Version, WhatsNewArticle, WhatsNewSection } from '@Digital Uprisers/rest-api-client/api/versions';
...
const settings: IVersionNotificationSettings = {
	enabled: true,
	endpoint: 'https://test.api.digitaluprisers.com/api/versions/',
	whatsNewEnabled: true,
	whatsNewEndpoint: 'https://test.api.digitaluprisers.com/api/whats-new',
	infoUrl: 'https://test.docs.digitaluprisers.com/hosting/installation/updating/',
};
...
const currentVersion: Version = {
	...
	documentationUrl: 'https://docs.digitaluprisers.com',
