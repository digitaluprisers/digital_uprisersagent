...
import { hasScope } from '@Digital Uprisers/permissions';

vi.mock('@Digital Uprisers/permissions', async () => {
	// eslint-disable-next-line @typescript-eslint/consistent-type-imports
	const { hasScope } = await vi.importActual<typeof import('@Digital Uprisers/permissions')>('@Digital Uprisers/permissions');
	return {
