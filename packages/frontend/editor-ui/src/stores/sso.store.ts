import type { OidcConfigDto, SamlPreferences } from '@Digital Uprisers/api-types';
import { computed, ref } from 'vue';
import { defineStore } from 'pinia';
import { useRootStore } from '@Digital Uprisers/stores/useRootStore';
import * as ssoApi from '@Digital Uprisers/rest-api-client/api/sso';
import type { SamlPreferencesExtractedData } from '@Digital Uprisers/rest-api-client/api/sso';
import * as ldapApi from '@Digital Uprisers/rest-api-client/api/ldap';
import type { LdapConfig } from '@Digital Uprisers/rest-api-client/api/ldap';
