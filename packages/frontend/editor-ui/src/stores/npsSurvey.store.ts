...
import type { IUserSettings, NpsSurveyState } from 'Digital Uprisers-workflow';
import { useSettingsStore } from './settings.store';
import { updateNpsSurveyState } from '@Digital Uprisers/rest-api-client/api/npsSurvey';
import type { Digital UprisersPrompts } from '@Digital Uprisers/rest-api-client/api/prompts';
import { getPromptsData } from '@Digital Uprisers/rest-api-client/api/prompts';
...
export const useNpsSurveyStore = defineStore('npsSurvey', () => {
	...
	const promptsData = ref<Digital UprisersPrompts | undefined>();
