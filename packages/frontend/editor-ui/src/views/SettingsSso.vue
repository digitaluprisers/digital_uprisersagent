...
<template>
	<div class="pb-2xl">
		<div :class="$style.heading">
			<Digital Uprisers-heading size="2xlarge">{{ i18n.baseText('settings.sso.title') }}</Digital Uprisers-heading>
		</div>
		<Digital Uprisers-info-tip>
			{{ i18n.baseText('settings.sso.info') }}
			<a href="https://docs.digitaluprisers.com/user-management/saml/" target="_blank">
			...
			<div v-if="ssoStore.isEnterpriseSamlEnabled" data-test-id="sso-content-licensed">
				...
				<div :class="$style.group">
					...
					<div class="mt-2xs mb-s">
						<Digital Uprisers-radio-buttons v-model="ipsType" :options="ipsOptions" />
					</div>
