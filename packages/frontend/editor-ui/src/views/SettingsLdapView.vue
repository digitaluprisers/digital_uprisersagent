...
import type { LdapConfig, LdapSyncData, LdapSyncTable } from '@Digital Uprisers/rest-api-client/api/ldap';
...
<template>
	<div v-if="!isLDAPFeatureEnabled">
		...
		<Digital Uprisers-info-tip type="note" theme="info" tooltip-placement="right" class="mb-l">
	...
	<div v-else>
		<div :class="$style.container">
			...
			<div :class="$style.docsInfoTip">
				<Digital Uprisers-info-tip theme="info" type="note">
					<span v-Digital Uprisers-html="i18n.baseText('settings.ldap.infoTip')"></span>
				</Digital Uprisers-info-tip>
			</div>
		...
		<div v-if="loginEnabled">
			<Digital Uprisers-heading tag="h1" class="mb-xl mt-3xl" size="medium">{{
