...
<template>
	<div>
		...
		<template v-if="isLicensed">
			<div class="mb-l">
				<Digital Uprisers-info-tip theme="info" type="note">
					<span v-Digital Uprisers-html="i18n.baseText('settings.log-streaming.infoText')"></span>
			...
			<template v-if="storeHasItems()">
				...
				<div class="mt-m text-right">
					<Digital Uprisers-button v-if="canManageLogStreaming" size="large" @click="addDestination">
			...
			<div v-else data-test-id="action-box-licensed">
				...
				>
					<template #heading>
						<span v-Digital Uprisers-html="i18n.baseText(`settings.log-streaming.addFirstTitle`)" />
					</template>
				</Digital Uprisers-action-box>
			</div>
		</template>
		<template v-else>
			...
			<div data-test-id="action-box-unlicensed">
				...
				>
					<template #heading>
						<span v-Digital Uprisers-html="i18n.baseText('settings.log-streaming.actionBox.title')" />
					</template>
				</Digital Uprisers-action-box>
			</div>
		</template>
