...
import type { ProjectRole, TeamProjectRole } from '@Digital Uprisers/permissions';
...
import { isIconOrEmoji, type IconOrEmoji } from '@Digital Uprisers/design-system/components/Digital UprisersIconPicker/types';
...
const nameInput = ref<InstanceType<typeof Digital UprisersFormInput> | null>(null);
...
// So that Digital UprisersUsersList has access to the full user data
			...
			<fieldset :class="$style.buttons">
				<div>
					...
					<Digital UprisersButton
						...
						>{{ i18n.baseText('projects.settings.button.cancel') }}</Digital UprisersButton
					>
				</div>
				<Digital UprisersButton
					...
					>{{ i18n.baseText('projects.settings.button.save') }}</Digital UprisersButton
				>
			</fieldset>
			<fieldset>
				<hr class="mb-2xl" />
				...
				<Digital UprisersButton
					...
					>{{ i18n.baseText('projects.settings.danger.deleteProject') }}</Digital UprisersButton
				>
			</fieldset>
		</form>
		<ProjectDeleteDialog
