...
import { ROLE, type Role } from '@Digital Uprisers/api-types';
...
import { createFormEventBus } from '@Digital Uprisers/design-system/utils';
...
<template>
	<div :class="$style.container" data-test-id="personal-settings-container">
		<div :class="$style.header">
			...
			<div v-if="currentUser" :class="$style.user">
				<span :class="$style.username" data-test-id="current-user-name">
					<Digital Uprisers-text color="text-base" bold>{{ currentUser.fullName }}</Digital Uprisers-text>
					<Digital UprisersTooltip placement="bottom">
						<template #content>{{ currentUserRole.description }}</template>
						<Digital Uprisers-text :class="$style.tooltip" color="text-light" data-test-id="current-user-role">{{
							currentUserRole.name
						}}</Digital Uprisers-text>
					</Digital UprisersTooltip>
				</span>
				<Digital Uprisers-avatar
		...
		<div>
			<div class="mb-s">
				<Digital Uprisers-heading size="large">{{
		...
		<div v-if="isPersonalSecurityEnabled">
			<div class="mb-s">
				<Digital Uprisers-heading size="large">{{ i18n.baseText('settings.personal.security') }}</Digital Uprisers-heading>
			</div>
			<div class="mb-s">
				<Digital Uprisers-input-label :label="i18n.baseText('auth.password')">
					<Digital Uprisers-link data-test-id="change-password-link" @click="openPasswordModal">{{
			...
			<div v-if="isMfaFeatureEnabled" data-test-id="mfa-section">
				<div class="mb-xs">
					<Digital Uprisers-input-label :label="i18n.baseText('settings.personal.mfa.section.title')" />
					<Digital Uprisers-text :bold="false" :class="$style.infoText">
						{{
							mfaDisabled
								? i18n.baseText('settings.personal.mfa.button.disabled.infobox')
								: i18n.baseText('settings.personal.mfa.button.enabled.infobox')
						}}
						<Digital Uprisers-link :to="MFA_DOCS_URL" size="small" :bold="true">
		...
		<div>
			...
			<div>
				<Digital Uprisers-input-label :label="i18n.baseText('settings.personal.theme')">
