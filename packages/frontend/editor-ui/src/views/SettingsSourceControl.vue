...
import type { Rule, RuleGroup } from '@Digital Uprisers/design-system/types';
import { useI18n } from '@Digital Uprisers/i18n';
import type { Validatable } from '@Digital Uprisers/design-system';
...
<template>
	<div>
		<Digital Uprisers-heading size="2xlarge" tag="h1">{{
		...
		>
			<Digital Uprisers-callout theme="secondary" icon="info" class="mt-2xl mb-l">
			...
			<Digital Uprisers-heading size="xlarge" tag="h2" class="mb-s">{{
			...
			<div :class="$style.group">
				...
				<div :class="$style.groupFlex">
					...
					<Digital Uprisers-button
						...
						@click="onDisconnect"
						>{{ locale.baseText('settings.sourceControl.button.disconnect') }}</Digital Uprisers-button
					>
				</div>
			</div>
			<div v-if="sourceControlStore.preferences.publicKey" :class="$style.group">
				...
				<Digital Uprisers-notice type="info" class="mt-s">
			...
			<Digital Uprisers-button
				...
				@click="onConnect"
				>{{ locale.baseText('settings.sourceControl.button.connect') }}</Digital Uprisers-button
			>
			<div v-if="isConnected" data-test-id="source-control-connected-content">
				<div :class="$style.group">
					...
					<div :class="$style.branchSelection">
						...
						/>
						<Digital Uprisers-tooltip placement="top">
							<template #content>
								<span>
				...
				<div :class="$style.group">
					...
					<div>
						<Digital Uprisers-color-picker v-model="sourceControlStore.preferences.branchColor" size="small" />
					</div>
				</div>
				<div :class="[$style.group, 'pt-s']">
					<Digital Uprisers-button
						...
						@click="onSave"
						>{{ locale.baseText('settings.sourceControl.button.save') }}</Digital Uprisers-button
					>
				</div>
			</div>
		</div>
