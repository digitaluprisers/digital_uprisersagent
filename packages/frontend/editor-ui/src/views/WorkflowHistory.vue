...
import type {
	...
	WorkflowHistory,
	WorkflowVersion,
} from '@Digital Uprisers/rest-api-client/api/workflowHistory';
...
<template>
	<div :class="$style.view">
		<div :class="$style.header">
			<Digital Uprisers-heading tag="h2" size="medium">
				{{ activeWorkflow?.name }}
			</Digital Uprisers-heading>
			<span v-if="activeWorkflow?.isArchived">
				<Digital UprisersBadge class="ml-s" theme="tertiary" bold data-test-id="workflow-archived-tag">
					{{ i18n.baseText('workflows.item.archived') }}
				</Digital UprisersBadge>
			</span>
		</div>
		<div :class="$style.corner">
			<Digital Uprisers-heading tag="h2" size="medium" bold>
				{{ i18n.baseText('workflowHistory.title') }}
			</Digital Uprisers-heading>
			<router-link :to="editorRoute" data-test-id="workflow-history-close-button">
				<Digital Uprisers-button type="tertiary" icon="x" size="small" text square />
			</router-link>
		</div>
