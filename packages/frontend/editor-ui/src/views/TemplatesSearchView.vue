...
import type { ITemplatesCategory } from '@Digital Uprisers/rest-api-client/api/templates';
		...
		<template #header>
			<div :class="$style.wrapper">
				<div :class="$style.title">
					<Digital Uprisers-heading tag="h1" size="2xlarge">
				...
				<div :class="$style.search">
					...
					<div v-show="collections.length || loadingCollections" :class="$style.carouselContainer">
						<div :class="$style.header">
							<Digital Uprisers-heading :bold="true" size="medium" color="text-light">
					...
					<div v-if="endOfSearchMessage" :class="$style.endText">
						<Digital Uprisers-text size="medium" color="text-base">
							<span v-Digital Uprisers-html="endOfSearchMessage" />
