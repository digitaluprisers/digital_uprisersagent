	...
	<div :class="$style.evaluationsView">
		<template v-if="isReady && showWizard">
			<div :class="$style.setupContent">
				<div>
					<Digital UprisersText size="large" color="text-dark" tag="h3" bold>
						{{ locale.baseText('evaluations.setupWizard.title') }}
					</Digital UprisersText>
					<Digital UprisersText tag="p" size="small" color="text-base" :class="$style.description">
						{{ locale.baseText('evaluations.setupWizard.description') }}
						<Digital UprisersLink size="small" href="https://docs.digitaluprisers.com/advanced-ai/evaluations/overview">{{
				...
				<div :class="$style.config">
					<iframe
						...
						title="Digital Uprisers Evaluation quickstart"
						frameborder="0"
