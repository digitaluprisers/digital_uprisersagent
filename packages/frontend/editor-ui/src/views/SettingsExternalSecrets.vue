...
<template>
	<div class="pb-3xl">
		<Digital Uprisers-heading size="2xlarge">{{ i18n.baseText('settings.externalSecrets.title') }}</Digital Uprisers-heading>
		<div
			v-if="externalSecretsStore.isEnterpriseExternalSecretsEnabled"
			data-test-id="external-secrets-content-licensed"
		>
			<Digital Uprisers-callout theme="secondary" class="mt-2xl mb-l">
