...
const testTemplate1 = mock<ITemplatesWorkflowFull>({
	...
	workflow: {
		nodes: [
			mockTemplateNode('IMAP Email', 'Digital Uprisers-nodes-base.emailReadImap'),
			mockTemplateNode('Nextcloud', 'Digital Uprisers-nodes-base.nextCloud'),
		],
	},
	full: true,
});
...
const testTemplate2 = mock<ITemplatesWorkflowFull>({
	...
	workflow: {
		nodes: [
			{
				...mockTemplateNode('Telegram', 'Digital Uprisers-nodes-base.telegram'),
				credentials: {
			...
			expect(setupTemplateStore.credentialUsages).toEqual([
				{
					...
					credentialType: 'imap',
					key: 'imap-',
					nodeTypeName: 'Digital Uprisers-nodes-base.emailReadImap',
				...
				},
				{
					...
					key: 'nextCloudApi-',
					nodeTypeName: 'Digital Uprisers-nodes-base.nextCloud',
