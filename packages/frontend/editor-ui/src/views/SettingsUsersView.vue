...
import type { TableOptions } from '@Digital Uprisers/design-system/components/Digital UprisersDataTableServer';
import {
...
<template>
	<div :class="$style.container">
		<Digital Uprisers-heading tag="h1" size="2xlarge" class="mb-xl">
		...
		<Digital Uprisers-notice v-if="!isAdvancedPermissionsEnabled">
		...
		<div :class="$style.settingsContainer">
			<div :class="$style.settingsContainerInfo">
				<Digital Uprisers-text :bold="true">{{ i18n.baseText('settings.personal.mfa.enforce.title') }}</Digital Uprisers-text>
		...
		<div v-if="!showUMSetupWarning" :class="$style.buttonContainer">
			...
			<Digital Uprisers-tooltip :disabled="!ssoStore.isSamlLoginEnabled">
				<template #content>
