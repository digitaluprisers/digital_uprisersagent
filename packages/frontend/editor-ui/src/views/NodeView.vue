...
import type { IWorkflowTemplate } from '@Digital Uprisers/rest-api-client/api/templates';
...
import { Digital UprisersCallout } from '@Digital Uprisers/design-system';
...
import { useAgentRequestStore } from '@Digital Uprisers/stores/useAgentRequestStore';
...
function emitPostMessageReady() {
	if (window.parent) {
		window.parent.postMessage(
			JSON.stringify({ command: 'Digital UprisersReady', version: rootStore.versionCli }),
			'*',
		);
	}
}
