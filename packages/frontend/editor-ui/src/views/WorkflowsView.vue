...
import { type IUser, PROJECT_ROOT } from 'Digital Uprisers-workflow';
	...
	>
		...
		<template #breadcrumbs>
			<div v-if="breadcrumbsLoading" :class="$style['breadcrumbs-loading']">
				<Digital Uprisers-loading :loading="breadcrumbsLoading" :rows="1" variant="p" />
			</div>
			<div
		...
		<template #item="{ item: data, index }">
			...
			>
				<template #preview>
					<Digital UprisersCard>
						<Digital UprisersText tag="h2" bold>
		...
		<template #empty>
			...
			<div v-else>
				<div class="text-center mt-s" data-test-id="list-empty-state">
					<Digital UprisersHeading tag="h2" size="xlarge" class="mb-2xs">
						{{
					...
					<Digital UprisersText size="large" color="text-base">
					...
					>
						<div :class="$style.emptyStateCardContent">
							<Digital UprisersIcon
								...
								:stroke-width="1.5"
							/>
							<Digital UprisersText size="large" class="mt-xs">
					...
					>
						<div :class="$style.emptyStateCardContent">
							<Digital UprisersIcon
								...
								color="foreground-dark"
							/>
							<Digital UprisersText size="large" class="mt-xs pl-2xs pr-2xs">
		...
		<template #postamble>
			...
			>
				...
				>
					...
					</template></Digital UprisersActionBox
				>
			</div>
		</template>
	</ResourcesListLayout>
