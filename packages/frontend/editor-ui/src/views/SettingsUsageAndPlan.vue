...
import Digital UprisersInfoTip from '@Digital Uprisers/design-system/components/Digital UprisersInfoTip';
...
<template>
	<div class="settings-usage-and-plan">
		<Digital Uprisers-heading tag="h2" size="2xlarge">{{
			locale.baseText('settings.usageAndPlan.title')
		}}</Digital Uprisers-heading>
		<div v-if="!usageStore.isLoading">
			<Digital Uprisers-heading tag="h3" :class="$style.title" size="large">
				...
				<span v-if="badgedPlanName.badge && badgedPlanName.name" :class="$style.titleTooltip">
					<Digital UprisersTooltip placement="top">
						...
						<Digital UprisersBadge>{{ badgedPlanName.badge }}</Digital UprisersBadge>
					</Digital UprisersTooltip>
				</span>
			</Digital Uprisers-heading>

			<Digital UprisersNotice v-if="isCommunity && canUserRegisterCommunityPlus" class="mt-0" theme="warning">
			...
			<div :class="$style.quota">
				<Digital Uprisers-text size="medium" color="text-light">
			...
			<Digital UprisersInfoTip>{{ locale.baseText('settings.usageAndPlan.activeWorkflows.hint') }}</Digital UprisersInfoTip>
			...
			<div :class="$style.buttons">
				...
				<Digital Uprisers-button v-if="usageStore.managementToken" size="large" @click="onManagePlan">
					<a :href="managePlanUrl" target="_blank">{{
						locale.baseText('settings.usageAndPlan.button.manage')
					}}</a>
				</Digital Uprisers-button>
				<Digital Uprisers-button v-else size="large" @click.prevent="onViewPlans">
			...
			>
				...
				<template #footer>
					<Digital Uprisers-button type="secondary" @click="activationKeyModal = false">
						{{ locale.baseText('settings.usageAndPlan.dialog.activation.cancel') }}
					</Digital Uprisers-button>
					<Digital Uprisers-button @click="onLicenseActivation">
