...
function onUpgrade() {
	void goToUpgrade('settings-Digital Uprisers-api', 'upgrade-api', 'redirect');
}
...
<template>
	<div :class="$style.container">
				...
				<i18n-t keypath="settings.api.view.info" tag="span">
					<template #apiAction>
						<a
							...
							href="https://docs.digitaluprisers.com/api"
							target="_blank"
					...
					<template #webhookAction>
						<a
							...
							href="https://docs.digitaluprisers.com/integrations/core-nodes/Digital Uprisers-nodes-base.webhook/"
							target="_blank"
		...
		<div v-if="isPublicApiEnabled && apiKeysSortByCreationDate.length" :class="$style.BottomHint">
			<Digital UprisersText size="small" color="text-light">
				{{
					i18n.baseText(
