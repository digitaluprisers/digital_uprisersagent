...
function createProjectTrio(name: string, containerConfig: any): Project[] {
	...
	const customEnv = process.env.DIGITAL_UPRISERS_TEST_ENV ? JSON.parse(process.env.DIGITAL_UPRISERS_TEST_ENV) : {};
	...
	const shouldAddDependencies = process.env.DIGITAL_UPRISERS_BASE_URL;
...
export default defineConfig({
	...
	projects: process.env.DIGITAL_UPRISERS_BASE_URL
		? containerConfigs
