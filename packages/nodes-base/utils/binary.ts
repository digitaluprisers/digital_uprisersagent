...
import type { IBinaryData, IDataObject, IExecuteFunctions, INodeExecutionData } from 'Digital Uprisers-workflow';
import { NodeOperationError, BINARY_ENCODING } from 'Digital Uprisers-workflow';
