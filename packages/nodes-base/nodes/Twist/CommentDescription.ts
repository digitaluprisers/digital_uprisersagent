	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description:
					'The users that will attached to the comment. Choose from the list, or specify IDs using an <a href="https://docs.digitaluprisers.com/code/expressions/">expression</a>.',
			},
			{
