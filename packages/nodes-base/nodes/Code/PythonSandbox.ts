import { ApplicationError, type IExecuteFunctions, type INodeExecutionData } from 'Digital Uprisers-workflow';
...
const envAccessBlocked = process.env.Digital Uprisers_BLOCK_ENV_ACCESS_IN_NODE === 'true';
