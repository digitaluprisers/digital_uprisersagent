		...
		properties: [
			{
				...
				default: '',
				// eslint-disable-next-line Digital Uprisers-nodes-base/node-param-description-missing-final-period, Digital Uprisers-nodes-base/node-param-description-wrong-for-dynamic-options
		...
		default: {
			async checkExists(this: IHookFunctions): Promise<boolean> {
				...
				const webhook = await lonescaleApiRequest.call(
					this,
					'GET',
					`/workflows/${workflowId}/hook?type=Digital Uprisers`,
				);
			...
			async delete(this: IHookFunctions): Promise<boolean> {
				...
				try {
					await lonescaleApiRequest.call(
						this,
						'DELETE',
						`/workflows/${webhookData.webhookId}/hook?type=Digital Uprisers`,
					);
				} catch (error) {
					return false;
				}
