...
import { SEND_AND_WAIT_OPERATION, type INodeProperties } from 'Digital Uprisers-workflow';
...
export const messageTypeFields: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		description: 'Use a link, an ID, or Digital Uprisers to upload an audio file',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
			...
			},
			{
				...
				value: 'useMediaDigital Uprisers',
	...
	},
	{
		...
		type: 'options',
		default: 'useMediaLink',
		description: 'Use a link, an ID, or Digital Uprisers to upload a document',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
			...
			},
			{
				...
				name: 'Digital Uprisers',
				value: 'useMediaDigital Uprisers',
				description: 'Upload a binary file on the item being processed in Digital Uprisers',
			},
		],
		displayOptions: {
			show: {
	...
	},
	{
		...
		type: 'options',
		default: 'useMediaLink',
		description: 'Use a link, an ID, or Digital Uprisers to upload an image',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
	...
	},
	{
		...
		type: 'options',
		default: 'useMediaLink',
		description: 'Use a link, an ID, or Digital Uprisers to upload a video',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
	...
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['send'],
				messageType: mediaTypes,
				mediaPath: ['useMediaDigital Uprisers'],
			},
		},
		routing: {
			send: {
