import type { IExecuteFunctions, INodeType, INodeTypeDescription } from 'Digital Uprisers-workflow';
import { NodeConnectionTypes, NodeOperationError, SEND_AND_WAIT_OPERATION } from 'Digital Uprisers-workflow';
