...
import type { INodeExecutionData, IDigital UprisersHttpFullResponse, JsonObject } from 'Digital Uprisers-workflow';
...
describe('handleError', () => {
	...
	beforeEach(() => {
		...
		response = { statusCode: 200, body: {} } as IDigital UprisersHttpFullResponse;
	});
