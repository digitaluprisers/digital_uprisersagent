...
import { type INodeTypeBaseDescription, type ITriggerFunctions } from 'Digital Uprisers-workflow';

import { type ICredentialsDataImap } from '@credentials/Imap.credentials';

import { EmailReadImapV2 } from '../../v2/EmailReadImapV2.node';

jest.mock('@Digital Uprisers/imap', () => {
	const originalModule = jest.requireActual('@Digital Uprisers/imap');
