import { sleep, NodeOperationError, jsonParse, NodeConnectionTypes } from 'Digital Uprisers-workflow';
import type {
	IDataObject,
	ITriggerFunctions,
	INodeExecutionData,
...
export class SimulateTrigger implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			{ ...iconSelector, default: 'Digital Uprisers-nodes-base.manualTrigger' },
			subtitleProperty,
