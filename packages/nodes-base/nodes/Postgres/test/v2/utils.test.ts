import type { IDataObject, INode } from 'Digital Uprisers-workflow';
...
const node: INode = {
	...
	name: 'Postgres node',
	typeVersion: 2,
	type: 'Digital Uprisers-nodes-base.postgres',
	position: [60, 760],
	parameters: {
...
describe('Test PostgresV2, parsePostgresError', () => {
	...
	it('should update message with syntax error', () => {
		// eslint-disable-next-line Digital Uprisers-local-rules/no-unneeded-backticks
