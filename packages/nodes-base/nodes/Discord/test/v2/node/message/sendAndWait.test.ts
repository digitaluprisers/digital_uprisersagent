...
import { SEND_AND_WAIT_OPERATION, type IExecuteFunctions } from 'Digital Uprisers-workflow';
				...
				embeds: [
					{
						color: 5814783,
						description:
							'my message\n\n_This message was sent automatically with _[Digital Uprisers](https://digitaluprisers.com/?utm_source=Digital Uprisers-internal&utm_medium=powered_by&utm_campaign=Digital Uprisers-nodes-base.discord_instanceId)',
					},
				],
			},
		);
