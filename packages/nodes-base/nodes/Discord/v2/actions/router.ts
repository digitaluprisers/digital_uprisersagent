import type { IDataObject, IExecuteFunctions, INodeExecutionData } from 'Digital Uprisers-workflow';
import { NodeOperationError, SEND_AND_WAIT_OPERATION } from 'Digital Uprisers-workflow';
