...
import { jsonParse, NodeApiError, NodeOperationError } from 'Digital Uprisers-workflow';
...
export function createSendAndWaitMessageBody(context: IExecuteFunctions) {
	...
	if (config.appendAttribution !== false) {
		...
		const link = createUtmCampaignLink('Digital Uprisers-nodes-base.discord', instanceId);
