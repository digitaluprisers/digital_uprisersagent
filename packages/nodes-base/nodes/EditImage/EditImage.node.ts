...
import { NodeOperationError, NodeConnectionTypes, deepCopy } from 'Digital Uprisers-workflow';
				...
				options: [
					{
						...
						values: [
							...
							...nodeOperationOptions,
							{
								...
								default: '',
								description:
									'The font to use. Defaults to Arial. Choose from the list, or specify an ID using an <a href="https://docs.digitaluprisers.com/code/expressions/">expression</a>.',
							},
						],
					},
				],
