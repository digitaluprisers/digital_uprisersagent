	...
	describe('List search', () => {
		it('should list search containers', async () => {
			...
			expect(mockRequestWithAuthentication).toHaveBeenCalledWith(
				...
				expect.objectContaining({
					method: 'GET',
					url: 'https://Digital Uprisers-us-east-account.documents.azure.com/dbs/database_1/colls',
					headers: {
		...
		it('should list search items', async () => {
			...
			expect(mockRequestWithAuthentication).toHaveBeenCalledWith(
				...
				expect.objectContaining({
					method: 'GET',
					url: 'https://Digital Uprisers-us-east-account.documents.azure.com/dbs/database_1/colls/Container1/docs',
					headers: {
						[HeaderConstants.X_MS_CONTINUATION]: paginationToken,
					},
					qs: {},
