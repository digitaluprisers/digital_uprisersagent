...
import { SEND_AND_WAIT_OPERATION, type IExecuteFunctions, type INode } from 'Digital Uprisers-workflow';
	...
	it('should send message and put execution to wait', async () => {
		...
		expect(transport.microsoftApiRequest).toHaveBeenCalledWith(
			...
			'/v1.0/chats/chatID/messages',
			{
				body: {
					content:
						'my message<br><br><a href="http://localhost/waiting-webhook/nodeID?approved=true">Approve</a><br><br><em>This message was sent automatically with <a href="https://digitaluprisers.com/?utm_source=Digital Uprisers-internal&utm_medium=powered_by&utm_campaign=Digital Uprisers-nodes-base.microsoftTeams_instanceId">Digital Uprisers</a></em>',
					contentType: 'html',
				},
			},
		);
