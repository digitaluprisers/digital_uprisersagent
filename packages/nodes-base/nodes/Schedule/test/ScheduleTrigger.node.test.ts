import * as Digital UprisersWorkflow from 'Digital Uprisers-workflow';
...
describe('ScheduleTrigger', () => {
	Object.defineProperty(Digital UprisersWorkflow, 'randomInt', {
	...
	describe('trigger', () => {
		...
		it('should throw on invalid cron expressions', async () => {
			...
			).rejects.toBeInstanceOf(Digital UprisersWorkflow.NodeOperationError);
		});
