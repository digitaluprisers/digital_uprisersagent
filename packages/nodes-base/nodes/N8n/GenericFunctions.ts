...
export async function apiRequest(
	...
	type Digital UprisersApiCredentials = {
		apiKey: string;
		baseUrl: string;
	};

	const credentials = await this.getCredentials<Digital UprisersApiCredentials>('Digital UprisersApi');
	...
	try {
		return await this.helpers.requestWithAuthentication.call(this, 'Digital UprisersApi', options);
	} catch (error) {
...
/**
 * Get a cursor-based paginator to use with Digital Uprisers 'getAll' type endpoints.
 *
