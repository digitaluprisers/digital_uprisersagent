...
const createOperation: INodeProperties[] = [
	{
		...
		type: 'string',
		default: '',
		placeholder: 'e.g. Digital Uprisers account',
		required: true,
		displayOptions: {
			show: {
				resource: ['credential'],
	...
	},
	{
		...
		type: 'string',
		placeholder: 'e.g. Digital UprisersApi',
		default: '',
		required: true,
		displayOptions: {
			show: {
		...
		description:
			"The available types depend on nodes installed on the Digital Uprisers instance. Some built-in types include e.g. 'githubApi', 'notionApi', and 'slackApi'.",
	},
	{
		displayName: 'Data',
		name: 'data',
		...
		default: '',
		placeholder:
			'// e.g. for Digital UprisersApi \n{\n  "apiKey": "my-Digital Uprisers-api-key",\n  "baseUrl": "https://<name>.app.Digital Uprisers.cloud/api/v1",\n}',
		required: true,
		typeOptions: {
