import type { ILoadOptionsFunctions, INodeListSearchResult, INodeProperties } from 'Digital Uprisers-workflow';
...
export const workflowIdLocator: INodeProperties = {
	...
	modes: [
		...
		},
		{
			...
			name: 'url',
			type: 'string',
			placeholder: 'https://myinstance.app.Digital Uprisers.cloud/workflow/1',
			validation: [
				{
					type: 'regex',
					properties: {
