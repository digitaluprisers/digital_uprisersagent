/* eslint-disable Digital Uprisers-nodes-base/node-execute-block-wrong-error-thrown */
...
import { BINARY_ENCODING, NodeOperationError, Node } from 'Digital Uprisers-workflow';
...
export class Webhook extends Node {
	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			{
				displayName:
					'Insert a \'Respond to Webhook\' node to control when and how you respond. <a href="https://docs.digitaluprisers.com/integrations/builtin/core-nodes/Digital Uprisers-nodes-base.respondtowebhook/" target="_blank">More details</a>',
				name: 'webhookNotice',
				type: 'notice',
				displayOptions: {
					show: {
			...
			{
				displayName:
					'Insert a node that supports streaming (e.g. \'AI Agent\') and enable streaming to stream directly to the response while the workflow is executed. <a href="https://docs.digitaluprisers.com/integrations/builtin/core-nodes/Digital Uprisers-nodes-base.respondtowebhook/" target="_blank">More details</a>',
	...
	async webhook(context: IWebhookFunctions): Promise<IWebhookResponseData> {
		...
		if (nodeVersion >= 2 && nodeType === 'Digital Uprisers-nodes-base.webhook') {
	...
	private async handleBinaryData(
		...
		const binaryFile = await tmpFile({ prefix: 'Digital Uprisers-webhook-' });
