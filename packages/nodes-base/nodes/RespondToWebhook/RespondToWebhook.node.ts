...
export class RespondToWebhook implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			{
				displayName:
					'Verify that the "Webhook" node\'s "Respond" parameter is set to "Using Respond to Webhook Node". <a href="https://docs.digitaluprisers.com/integrations/builtin/core-nodes/Digital Uprisers-nodes-base.respondtowebhook/" target="_blank">More details',
				name: 'generalNotice',
				type: 'notice',
				default: '',
			},
			...
			},
			{
				...
				default: '',
				placeholder: 'e.g. http://www.digitaluprisers.com',
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		let response: IDigital UprisersHttpFullResponse;
		...
		try {
			...
			let responseBody: IDigital UprisersHttpResponse | Readable;
			if (respondWith === 'json') {
