	...
	describe('Webhook lifecycle', () => {
		...
		function mockHookFunctions(
			...
			return mockDeep<IHookFunctions>({
				...
				getNodeWebhookUrl: jest.fn(() => 'https://Digital Uprisers.local/webhook/id'),
			...
			expect(mockCreateRequest).toHaveBeenCalledWith(
				...
				expect.objectContaining({
					...
					body: expect.objectContaining({
						...
						excludeBody: false,
						filters: {},
						name: 'Digital Uprisers-webhook:https://Digital Uprisers.local/webhook/id',
						url: 'https://Digital Uprisers.local/webhook/id',
					}),
				}),
			);
