		...
		this.description = {
			...
			properties: [
				...
				},
				{
					...
					// eslint-disable-next-line Digital Uprisers-nodes-base/node-param-description-wrong-for-dynamic-options
					description:
						'The name of SeaTable view to access. Choose from the list, or specify the name using an <a href="https://docs.digitaluprisers.com/code-examples/expressions/">expression</a>.',
				},
				{
					// eslint-disable-next-line Digital Uprisers-nodes-base/node-param-display-name-wrong-for-dynamic-options
					...
					// eslint-disable-next-line Digital Uprisers-nodes-base/node-param-description-wrong-for-dynamic-options
					description:
						'Select the digital-signature column that should be tracked. Choose from the list, or specify the name using an <a href="https://docs.digitaluprisers.com/code-examples/expressions/">expression</a>.',
				},
				{
					displayName: 'Options',
					name: 'options',
