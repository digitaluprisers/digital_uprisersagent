...
const properties: INodeProperties[] = [
	{
		...
		description:
			'Choose from the list, or specify a name using an <a href="https://docs.digitaluprisers.com/code-examples/expressions/">expression</a>',
	},
	{
		// eslint-disable-next-line Digital Uprisers-nodes-base/node-param-display-name-wrong-for-dynamic-options
		...
		// eslint-disable-next-line Digital Uprisers-nodes-base/node-param-description-wrong-for-dynamic-options
		description:
			'Choose from the list, or specify the name using an <a href="https://docs.digitaluprisers.com/code/expressions/">expression</a>',
	},
	{
		// eslint-disable-next-line Digital Uprisers-nodes-base/node-param-display-name-wrong-for-dynamic-options
		displayName: 'Row ID',
