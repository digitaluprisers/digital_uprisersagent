...
export const rowFields: INodeProperties[] = [
...

	{
		...
		description:
			'The name of SeaTable table to access. Choose from the list, or specify the name using an <a href="https://docs.digitaluprisers.com/code-examples/expressions/">expression</a>.',
	},
	{
		// eslint-disable-next-line Digital Uprisers-nodes-base/node-param-display-name-wrong-for-dynamic-options
		...
		description:
			'The name of SeaTable table to access. Choose from the list, or specify an ID using an <a href="https://docs.digitaluprisers.com/code/expressions/">expression</a>.',
	},
				...
				values: [
					{
						...
						// eslint-disable-next-line Digital Uprisers-nodes-base/node-param-description-wrong-for-dynamic-options
						description:
							'Choose from the list, or specify the name using an <a href="https://docs.digitaluprisers.com/code-examples/expressions/">expression</a>',
						typeOptions: {
		...
		options: [
			{
				...
				// eslint-disable-next-line Digital Uprisers-nodes-base/node-param-description-wrong-for-dynamic-options
				description:
					'Choose from the list, or specify an View Name using an <a href="https://docs.digitaluprisers.com/code-examples/expressions/">expression</a>',
				typeOptions: {
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				// eslint-disable-next-line Digital Uprisers-nodes-base/node-param-description-wrong-for-dynamic-options
				description:
					'Choose from the list, or specify a Column using an <a href="https://docs.digitaluprisers.com/code-examples/expressions/">expression</a>',
			},
		],
	},
];
