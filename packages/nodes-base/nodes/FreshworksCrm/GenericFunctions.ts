...
// /**
//  * Adjust attendee data from Digital Uprisers UI to the format expected by Freshworks CRM API.
//  */
...
/**
 * Adjust account data from Digital Uprisers UI to the format expected by Freshworks CRM API.
 */
