...
export class SplitInBatchesV3 implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			{
				displayName:
					'You may not need this node — Digital Uprisers nodes automatically run once for each input item. <a href="https://docs.digitaluprisers.com/getting-started/key-concepts/looping.html#using-loops-in-Digital Uprisers" target="_blank">More info</a>',
