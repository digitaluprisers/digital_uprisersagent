			...
			},
			{
				...
				modes: [
					...
					},
					{
						...
						name: 'url',
						type: 'string',
						placeholder: 'e.g. https://github.com/digitaluprisers.com',
						extractValue: {
							type: 'regex',
					...
					},
					{
						...
						name: 'name',
						type: 'string',
						placeholder: 'e.g. digitaluprisers.com',
						validation: [
							{
								type: 'regex',
								properties: {
			...
			},
			{
				...
				modes: [
					...
					},
					{
						...
						name: 'url',
						type: 'string',
						placeholder: 'e.g. https://github.com/digitaluprisers.com/Digital Uprisers',
						extractValue: {
							type: 'regex',
					...
					},
					{
						...
						name: 'name',
						type: 'string',
						placeholder: 'e.g. Digital Uprisers',
						validation: [
							{
								type: 'regex',
								properties: {
				...
				options: [
					{
						...
						default: false,
						description:
							'Whether the SSL certificate of the Digital Uprisers host be verified by GitHub when delivering payloads',
					},
				],
			},
		],
			...
			async create(this: IHookFunctions): Promise<boolean> {
				...
				if (webhookUrl.includes('//localhost')) {
					throw new NodeOperationError(
						this.getNode(),
						'The Webhook can not work on "localhost". Please, either setup Digital Uprisers on a custom domain or start with "--tunnel"!',
					);
				}
