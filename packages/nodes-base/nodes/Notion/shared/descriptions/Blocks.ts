import type { IDisplayOptions, INodeProperties } from 'Digital Uprisers-workflow';
...
const typeMention: INodeProperties[] = [
	...
	},
	{
		...
		default: '',
		description:
			'The ID of the user being mentioned. Choose from the list, or specify an ID using an <a href="https://docs.digitaluprisers.com/code/expressions/">expression</a>.',
	},
	{
		displayName: 'Page ID',
		name: 'page',
