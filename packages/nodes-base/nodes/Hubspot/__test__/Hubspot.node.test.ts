	...
	describe('companies', () => {
		beforeAll(() => {
			hubspotNock
				...
				.reply(200, companies.companies[0])
				.post('/companies/v2/domains/digitaluprisers.com/companies', { requestOptions: {}, limit: 100 })
	...
	describe('contacts', () => {
		beforeAll(() => {
			hubspotNock
				...
				.post('/contacts/v1/contact/createOrUpdate/email/elias@digitaluprisers.com', {
					properties: [
						{
						...
						{
							property: 'work_email',
							value: 'elias@digitaluprisers.com',
						},
						{
