import type { ILoadOptionsFunctions } from 'Digital Uprisers-workflow';
...
describe('GenericFunctions - searchLocations', () => {
	...
	it('should handle pagination', async () => {
		...
		// Digital Uprisers handles the pagination and adds the previous results to the results array
		expect(result).toEqual({
			// eslint-disable-next-line Digital Uprisers-nodes-base/node-param-display-name-miscased
