...
export const eventFields: INodeProperties[] = [
	...
	},
	{
		...
		default: '={{ $now }}',
		description:
			'Start time of the event, use <a href="https://docs.digitaluprisers.com/code/cookbook/luxon/" target="_blank">expression</a> to set a date, or switch to fixed mode to choose date from widget',
	},
	{
		displayName: 'End',
		name: 'end',
		...
		description:
			'End time of the event, use <a href="https://docs.digitaluprisers.com/code/cookbook/luxon/" target="_blank">expression</a> to set a date, or switch to fixed mode to choose date from widget',
	},
	{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description:
					'The color of the event. Choose from the list, or specify an ID using an <a href="https://docs.digitaluprisers.com/code/expressions/">expression</a>.',
			},
			{
	...
	},
	{
		...
		default: '={{ $now }}',
		description:
			'At least some part of the event must be after this time, use <a href="https://docs.digitaluprisers.com/code/cookbook/luxon/" target="_blank">expression</a> to set a date, or switch to fixed mode to choose date from widget',
		displayOptions: {
			show: {
				'@version': [{ _cnd: { gte: 1.3 } }],
				operation: ['getAll'],
	...
	},
	{
		...
		description:
			'At least some part of the event must be before this time, use <a href="https://docs.digitaluprisers.com/code/cookbook/luxon/" target="_blank">expression</a> to set a date, or switch to fixed mode to choose date from widget',
		displayOptions: {
			show: {
				'@version': [{ _cnd: { gte: 1.3 } }],
				operation: ['getAll'],
