...
export const calendarFields: INodeProperties[] = [
	...
	},
	{
		...
		default: '={{ $now }}',
		description:
			'Start of the interval, use <a href="https://docs.digitaluprisers.com/code/cookbook/luxon/" target="_blank">expression</a> to set a date, or switch to fixed mode to choose date from widget',
	},
	{
		displayName: 'End Time',
		name: 'timeMax',
		...
		description:
			'End of the interval, use <a href="https://docs.digitaluprisers.com/code/cookbook/luxon/" target="_blank">expression</a> to set a date, or switch to fixed mode to choose date from widget',
	},
	{
		displayName: 'Options',
		name: 'options',
		...
		options: [
			...
			},
			{
				...
				type: 'resourceLocator',
				default: { mode: 'list', value: '' },
				description: 'Time zone used in the response. By default Digital Uprisers timezone is used.',
				modes: [
					{
						displayName: 'Timezone',
						name: 'list',
