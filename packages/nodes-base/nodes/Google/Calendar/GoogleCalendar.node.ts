...
export class GoogleCalendar implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			{
				displayName:
					'This node will use the time zone set in Digital Uprisers’s settings, but you can override this in the workflow settings',
				name: 'useDigital UprisersTimeZone',
				type: 'notice',
				default: '',
			},
		],
