...
import type { IDataObject, IExecuteFunctions, INode } from 'Digital Uprisers-workflow';
							...
							v: [
								{
									v: {
										f: [
											...
											{
												v: 'Digital Uprisers-nodes-base.zendeskTrigger',
											},
											{
												v: {
													f: [
					...
					nodes: [
						{
							...
							type: 'Digital Uprisers-nodes-base.zendeskTrigger',
							parameters: [
								{
									conditions: [
										{
