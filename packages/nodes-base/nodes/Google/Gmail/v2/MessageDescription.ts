		...
		options: [
			{
				...
				description:
					'Whether to include the phrase “This email was sent automatically with Digital Uprisers” to the end of the email',
			},
			{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description:
					'Only return messages with labels that match all of the specified label IDs. Choose from the list, or specify IDs using an <a href="https://docs.digitaluprisers.com/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Search',
				name: 'q',
