...
import { NodeApiError, NodeConnectionTypes, randomString } from 'Digital Uprisers-workflow';
	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				required: true,
				description:
					'Form which should trigger workflow on submission. Choose from the list, or specify an ID using an <a href="https://docs.digitaluprisers.com/code/expressions/">expression</a>.',
			},
			{
	...
	webhookMethods = {
		default: {
			...
			async create(this: IHookFunctions): Promise<boolean> {
				...
				const formId = this.getNodeParameter('formId') as string;
				const webhookId = 'Digital Uprisers-' + randomString(10).toLowerCase();
