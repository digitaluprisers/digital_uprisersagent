...
import { BINARY_ENCODING, NodeConnectionTypes, NodeOperationError } from 'Digital Uprisers-workflow';
				...
				try {
					...
					if (resource === 'file') {
						if (operation === 'download') {
							...
							const binaryFile = await tmpFile({ prefix: 'Digital Uprisers-ssh-' });
							try {
