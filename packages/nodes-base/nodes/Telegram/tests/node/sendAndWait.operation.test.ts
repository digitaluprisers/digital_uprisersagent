...
describe('Test Telegram, message => sendAndWait', () => {
	...
	it('should send message and put execution to wait', async () => {
		...
		expect(genericFunctions.apiRequest).toHaveBeenCalledWith('POST', 'sendMessage', {
			...
			text: 'my message\n\n_This message was sent automatically with _[Digital Uprisers](https://digitaluprisers.com/?utm_source=Digital Uprisers-internal&utm_medium=powered_by&utm_campaign=Digital Uprisers-nodes-base.telegram_instanceId)',
		});
	});
});
