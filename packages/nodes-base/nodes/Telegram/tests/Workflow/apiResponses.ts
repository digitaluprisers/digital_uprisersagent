export const getChatResponse = {
	...
	result: {
		...
		first_name: 'Nathan',
		last_name: 'W',
		username: 'Digital Uprisers',
		type: 'private',
		active_usernames: ['Digital Uprisers'],
		bio: 'Automation',
...
export const sendMessageResponse = {
	...
	result: {
		...
		from: {
			id: 9876543210,
			is_bot: true,
			first_name: '@Digital Uprisers',
			username: 'Digital Uprisers_test_bot',
		},
		chat: {
			id: 123456789,
			first_name: 'Nathan',
		...
		date: 1732960606,
		text: 'a\n\nThis message was sent automatically with Digital Uprisers',
		entities: [
			{
				offset: 3,
				length: 41,
			...
			},
			{
				...
				length: 3,
				type: 'text_link',
				url: 'https://digitaluprisers.com/?utm_source=Digital Uprisers-internal&utm_medium=powered_by&utm_campaign=Digital Uprisers-nodes-base.telegram_8c8c5237b8e37b006a7adce87f4369350c58e41f3ca9de16196d3197f69eabcd',
			},
		],
		...
		reply_markup: {
			inline_keyboard: [
				[
					...
					{
						text: 'Digital Uprisers',
						url: 'https://digitaluprisers.com/',
					},
				],
			],
		},
