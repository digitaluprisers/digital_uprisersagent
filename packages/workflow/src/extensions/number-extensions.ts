...
ceil.doc = {
	...
	returnType: 'number',
	docURL: 'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/numbers/#number-ceil',
};
...
floor.doc = {
	...
	returnType: 'number',
	docURL: 'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/numbers/#number-floor',
};
...
isEven.doc = {
	...
	returnType: 'boolean',
	docURL: 'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/numbers/#number-isEven',
};
...
isOdd.doc = {
	...
	returnType: 'boolean',
	docURL: 'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/numbers/#number-isOdd',
};
...
format.doc = {
	...
	docURL: 'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/numbers/#number-format',
};
...
round.doc = {
	...
	docURL: 'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/numbers/#number-round',
};
...
toBoolean.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/numbers/#number-toBoolean',
};
...
toDateTime.doc = {
	...
	docURL:
		'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/numbers/#number-toDateTime',
};
...
abs.doc = {
	...
	returnType: 'number',
	docURL: 'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/numbers/#number-abs',
};
...
isInteger.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/numbers/#number-isInteger',
};
