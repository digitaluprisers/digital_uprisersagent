...
isEmpty.doc = {
	...
	returnType: 'boolean',
	docURL: 'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/objects/#object-isEmpty',
};
...
isNotEmpty.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/objects/#object-isNotEmpty',
};
...
compact.doc = {
	...
	returnType: 'Object',
	docURL: 'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/objects/#object-compact',
};
...
urlEncode.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/objects/#object-urlEncode',
};
...
hasField.doc = {
	...
	docURL: 'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/objects/#object-hasField',
};
...
removeField.doc = {
	...
	docURL:
		'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/objects/#object-removeField',
};
...
removeFieldsContaining.doc = {
	...
	docURL:
		'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/objects/#object-removeFieldsContaining',
};
...
keepFieldsContaining.doc = {
	...
	docURL:
		'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/objects/#object-keepFieldsContaining',
};
...
keys.doc = {
	...
	docURL: 'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/objects/#object-keys',
	returnType: 'Array',
};
...
values.doc = {
	...
	docURL: 'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/objects/#object-values',
	returnType: 'Array',
};
...
toJsonString.doc = {
	...
	docURL:
		'https://docs.digitaluprisers.com/code/builtin/data-transformation-functions/objects/#object-toJsonString',
	returnType: 'string',
};
