	...
	functions: {
		...
		search: {
			doc: {
				...
				examples: [
					{
						example: '"Neat Digital Uprisers node".search(/n[^ ]*/)',
						evaluated: '5',
						description: "Pos of first word starting with 'n'",
					},
					{
						example: '"Neat Digital Uprisers node".search(/n[^ ]*/i)',
						evaluated: '0',
						description:
		...
		slice: {
			doc: {
				...
				examples: [
					{ example: "'Hello from Digital Uprisers'.slice(0, 5)", evaluated: "'Hello'" },
					{ example: "'Hello from Digital Uprisers'.slice(6)", evaluated: "'from Digital Uprisers'" },
					{ example: "'Hello from Digital Uprisers'.slice(-3)", evaluated: "'Digital Uprisers'" },
				],
				section: 'edit',
				docURL:
		...
		substring: {
			doc: {
				...
				description:
					'Extracts a fragment of the string at the given position. For more advanced extraction, see <code>match()</code>.',
				examples: [
					{ example: "'Hello from Digital Uprisers'.substring(0, 5)", evaluated: "'Hello'" },
					{ example: "'Hello from Digital Uprisers'.substring(6)", evaluated: "'from Digital Uprisers'" },
				],
				section: 'edit',
				docURL:
