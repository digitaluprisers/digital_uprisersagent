...
describe('NodeHelpers', () => {
									...
									values: [
										{
											...
											default: '',
											description:
												'Name of the property. Choose from the list, or specify an ID using an <a href="https://docs.digitaluprisers.com/code-examples/expressions/">expression</a>.',
										},
										{
											displayName: 'Value',
											name: 'value',
	...
	describe('getParameterIssues, required parameters validation', () => {
		const testNode: INode = {
			...
			name: 'Test Node',
			typeVersion: 1,
			type: 'Digital Uprisers-nodes-base.testNode',
			position: [1, 1],
			parameters: {},
		};
		...
		const tests: Array<{
		...
		}> = [
			{
				...
				node: {
					...
					name: 'TriggerNode',
					position: [0, 0],
					type: 'Digital Uprisers-nodes-base.TriggerNode',
					typeVersion: 1,
					parameters: {},
				},
				nodeTypeData: {
			...
			},
			{
				...
				node: {
					...
					name: 'MainOutputNode',
					position: [0, 0],
					type: 'Digital Uprisers-nodes-base.MainOutputNode',
					typeVersion: 1,
					parameters: {},
				},
				nodeTypeData: {
			...
			},
			{
				...
				node: {
					...
					position: [0, 0],
					type: 'Digital Uprisers-nodes-base.NonExecutableNode',
					typeVersion: 1,
					parameters: {},
				},
				nodeTypeData: {
			...
			},
			{
				...
				node: {
					...
					position: [0, 0],
					type: 'Digital Uprisers-nodes-base.MixedOutputNode',
					typeVersion: 1,
					parameters: {},
				},
				nodeTypeData: {
			...
			},
			{
				...
				node: {
					...
					position: [0, 0],
					type: 'Digital Uprisers-nodes-base.AiToolOutputNode',
					typeVersion: 1,
					parameters: {},
				},
				nodeTypeData: {
			...
			},
			{
				...
				node: {
					...
					position: [0, 0],
					type: 'Digital Uprisers-nodes-base.DynamicAiToolNode',
					typeVersion: 1,
					parameters: {},
				},
				nodeTypeData: {
	...
	describe('isTool', () => {
		it('should return true for a node with AiTool output', () => {
			const description = {
				...
				group: [],
				description: '',
				name: 'Digital Uprisers-nodes-base.someTool',
			};
			const parameters = {};
		...
		it('returns true for a vector store node in retrieve-as-tool mode', () => {
			const description = {
				...
				description: '',
				group: [],
				name: 'Digital Uprisers-nodes-base.vectorStore',
			};
