...
import { NodeOperationError, fileTypeFromMimeType, ApplicationError } from 'Digital Uprisers-workflow';
...
/**
 * Takes a buffer and converts it into the format Digital Uprisers uses. It encodes the binary data as
