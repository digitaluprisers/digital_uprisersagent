import type { IDataObject, INodeExecutionData } from 'Digital Uprisers-workflow';

/**
 * Takes generic input data and brings it into the json format Digital Uprisers uses.
 *
