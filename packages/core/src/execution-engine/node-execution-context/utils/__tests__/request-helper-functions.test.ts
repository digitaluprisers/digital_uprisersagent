...
import {
	...
	convertDigital UprisersRequestToAxios,
...
describe('Request Helper Functions', () => {
	...
	describe('convertDigital UprisersRequestToAxios', () => {
		test('should convert basic HTTP request options', () => {
			...
			const axiosConfig = convertDigital UprisersRequestToAxios(requestOptions);
