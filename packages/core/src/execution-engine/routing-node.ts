...
import type {
	...
	IDigital UprisersRequestOperations,
	INodeProperties,
...
export class RoutingNode {
	...
	private async runPostReceiveAction(
		...
		responseData: IDigital UprisersHttpFullResponse,
	...
	private async rawRoutingRequest(
	...
	): Promise<IDigital UprisersHttpFullResponse> {
		let responseData: IDigital UprisersHttpFullResponse;
		...
		if (credentialType) {
			responseData = (await executeSingleFunctions.helpers.httpRequestWithAuthentication.call(
				...
				{ credentialsDecrypted },
			)) as IDigital UprisersHttpFullResponse;
		} else {
