...
import type { IConnections, INode, WorkflowParameters, NodeConnectionType } from 'Digital Uprisers-workflow';
 ...
 * To integrate easier with the Digital Uprisers codebase vertices are called nodes and
