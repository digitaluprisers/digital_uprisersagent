...
import type { IConnections, INode, INodeType, INodeTypes, IPinData, IRunData } from 'Digital Uprisers-workflow';
...
describe('findTriggerForPartialExecution', () => {
	...
	const manualTriggerNode = createNode('ManualTrigger', 'Digital Uprisers-nodes-base.manualTrigger');
	const disabledTriggerNode = createNode('DisabledTrigger', 'Digital Uprisers-nodes-base.manualTrigger', true);
	const pinnedTrigger = createNode('PinnedTrigger', 'Digital Uprisers-nodes-base.manualTrigger');
	const setNode = createNode('Set', 'Digital Uprisers-nodes-base.set');
	const noOpNode = createNode('No Operation', 'Digital Uprisers-nodes-base.noOp');
	const webhookNode = createNode('Webhook', 'Digital Uprisers-nodes-base.webhook');
	const webhookNode1 = createNode('Webhook1', 'Digital Uprisers-nodes-base.webhook');
	...
	describe('Error and Edge Case Handling', () => {
		...
		it('should prefer triggers that have run data', () => {
			// ARRANGE
			const trigger1 = createNodeData({ name: 'trigger1', type: 'Digital Uprisers-nodes-base.manualTrigger' });
			const trigger2 = createNodeData({ name: 'trigger2', type: 'Digital Uprisers-nodes-base.manualTrigger' });
