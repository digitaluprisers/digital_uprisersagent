import { NodeConnectionTypes, type INode, type IPinData, type IRunData } from 'Digital Uprisers-workflow';
...
function findStartNodesRecursive(
	...
	if (current.type === 'Digital Uprisers-nodes-base.splitInBatches') {
