...
export const predefinedNodesTypes: INodeTypeData = {
	...
	'Digital Uprisers-nodes-base.merge': {
		type: new Merge(),
		sourcePath: '',
	},
	'Digital Uprisers-nodes-base.noOp': {
		type: new NoOp(),
		sourcePath: '',
	},
	...
	'Digital Uprisers-nodes-base.splitInBatches': {
		type: new SplitInBatches(),
		sourcePath: '',
	},
	'@Digital Uprisers/Digital Uprisers-nodes-langchain.toolExecutor': {
		sourcePath: '',
		type: {
			description: {
	...
	'Digital Uprisers-nodes-base.toolTest': {
		sourcePath: '',
		type: {
			description: {
	...
	'Digital Uprisers-nodes-base.versionTest': {
		sourcePath: '',
		type: {
			description: {
			...
			workflowData: {
				nodes: [
					...
					},
					{
						...
						parameters: {},
						name: 'VersionTest1a',
						type: 'Digital Uprisers-nodes-base.versionTest',
						typeVersion: 1,
						position: [460, 300],
					},
					{
